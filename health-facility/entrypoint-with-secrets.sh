    ...
    while IFS='=' read -r key value; do
        ...
        case "$key" in
            ...
            "keycloak.backend.client.secret")
                ...
                ;;
            "keycloak.desktop.client.id")
                export KEYCLOAK_DESKTOP_CLIENT_ID="$value"
                echo "Loaded KEYCLOAK_DESKTOP_CLIENT_ID"
                ;;
            "keycloak.desktop.client.secret")
                export KEYCLOAK_DESKTOP_CLIENT_SECRET="$value"
                echo "Loaded KEYCLOAK_DESKTOP_CLIENT_SECRET"
                ;;
            "keycloak.realm")
...
echo "Starting Health Facility Service..."
exec java -jar /app/health-facility.jar
