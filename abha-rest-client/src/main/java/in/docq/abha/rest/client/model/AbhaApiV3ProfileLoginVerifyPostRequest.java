...
/**
 * AbhaApiV3ProfileLoginVerifyPostRequest
 */
...
public class AbhaApiV3ProfileLoginVerifyPostRequest {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3ProfileLoginVerifyPostRequestAuthData authData;

  public AbhaApiV3ProfileLoginVerifyPostRequest() {
  }

  public AbhaApiV3ProfileLoginVerifyPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileLoginVerifyPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileLoginVerifyPostRequest authData(@javax.annotation.Nonnull AbhaApiV3ProfileLoginVerifyPostRequestAuthData authData) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3ProfileLoginVerifyPostRequestAuthData getAuthData() {
    return authData;
  }

  public void setAuthData(@javax.annotation.Nonnull AbhaApiV3ProfileLoginVerifyPostRequestAuthData authData) {
    this.authData = authData;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyPostRequest abhaApiV3ProfileLoginVerifyPostRequest = (AbhaApiV3ProfileLoginVerifyPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileLoginVerifyPostRequest.scope) &&
        Objects.equals(this.authData, abhaApiV3ProfileLoginVerifyPostRequest.authData);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginVerifyPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyPostRequest is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileLoginVerifyPostRequest.openapiRequiredFields) {
      ...
      AbhaApiV3ProfileLoginVerifyPostRequestAuthData.validateJsonElement(jsonObj.get("authData"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyPostRequest
   */
  public static AbhaApiV3ProfileLoginVerifyPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyPostRequest to an JSON string
   *
   * @return JSON string
   */
