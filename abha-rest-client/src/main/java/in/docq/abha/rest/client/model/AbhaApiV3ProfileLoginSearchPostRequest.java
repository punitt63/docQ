...
/**
 * AbhaApiV3ProfileLoginSearchPostRequest
 */
...
public class AbhaApiV3ProfileLoginSearchPostRequest {
  public static final String SERIALIZED_NAME_AB_H_A_NUMBER = "ABHANumber";
  @SerializedName(SERIALIZED_NAME_AB_H_A_NUMBER)
  @javax.annotation.Nonnull
  private String abHANumber;

  public AbhaApiV3ProfileLoginSearchPostRequest() {
  }

  public AbhaApiV3ProfileLoginSearchPostRequest abHANumber(@javax.annotation.Nonnull String abHANumber) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginSearchPostRequest abhaApiV3ProfileLoginSearchPostRequest = (AbhaApiV3ProfileLoginSearchPostRequest) o;
    return Objects.equals(this.abHANumber, abhaApiV3ProfileLoginSearchPostRequest.abHANumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginSearchPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginSearchPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginSearchPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginSearchPostRequest is not found in the empty JSON string", AbhaApiV3ProfileLoginSearchPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginSearchPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginSearchPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileLoginSearchPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginSearchPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginSearchPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginSearchPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginSearchPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginSearchPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginSearchPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginSearchPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginSearchPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginSearchPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginSearchPostRequest
   */
  public static AbhaApiV3ProfileLoginSearchPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginSearchPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginSearchPostRequest to an JSON string
   *
   * @return JSON string
   */
