...
public class AbdmConsentManagement2RequestResponse {
  ...
  public AbdmConsentManagement2RequestResponse requestId(@javax.annotation.Nonnull UUID requestId) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbdmConsentManagement2RequestResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbdmConsentManagement2RequestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbdmConsentManagement2RequestResponse is not found in the empty JSON string", AbdmConsentManagement2RequestResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbdmConsentManagement2RequestResponse.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : AbdmConsentManagement2RequestResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbdmConsentManagement2RequestResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbdmConsentManagement2RequestResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbdmConsentManagement2RequestResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbdmConsentManagement2RequestResponse.class));
  ...
  /**
   * Create an instance of AbdmConsentManagement2RequestResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbdmConsentManagement2RequestResponse
   * @throws IOException if the JSON string is invalid with respect to AbdmConsentManagement2RequestResponse
   */
  public static AbdmConsentManagement2RequestResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbdmConsentManagement2RequestResponse.class);
  }

  /**
   * Convert an instance of AbdmConsentManagement2RequestResponse to an JSON string
   *
   * @return JSON string
   */
