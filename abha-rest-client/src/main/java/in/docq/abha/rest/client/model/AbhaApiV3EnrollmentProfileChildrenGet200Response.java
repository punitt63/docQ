...
/**
 * AbhaApiV3EnrollmentProfileChildrenGet200Response
 */
...
public class AbhaApiV3EnrollmentProfileChildrenGet200Response {
  public static final String SERIALIZED_NAME_PARENT_ABHA_NUMBER = "parentAbhaNumber";
  @SerializedName(SERIALIZED_NAME_PARENT_ABHA_NUMBER)
  ...
  @javax.annotation.Nullable
  private List<AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner> children = new ArrayList<>();

  public AbhaApiV3EnrollmentProfileChildrenGet200Response() {
  }

  public AbhaApiV3EnrollmentProfileChildrenGet200Response parentAbhaNumber(@javax.annotation.Nullable String parentAbhaNumber) {
    this.parentAbhaNumber = parentAbhaNumber;
    return this;
  }

  /**
   * Get parentAbhaNumber
   * @return parentAbhaNumber
   */
  @javax.annotation.Nullable
  public String getParentAbhaNumber() {
    return parentAbhaNumber;
  }

  public void setParentAbhaNumber(@javax.annotation.Nullable String parentAbhaNumber) {
    this.parentAbhaNumber = parentAbhaNumber;
  }


  public AbhaApiV3EnrollmentProfileChildrenGet200Response mobileNumber(@javax.annotation.Nullable String mobileNumber) {
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet200Response childrenCount(@javax.annotation.Nullable Integer childrenCount) {
  ...
  public void setChildrenCount(@javax.annotation.Nullable Integer childrenCount) {
    this.childrenCount = childrenCount;
  }


  public AbhaApiV3EnrollmentProfileChildrenGet200Response children(@javax.annotation.Nullable List<AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner> children) {
    this.children = children;
    return this;
  }

  public AbhaApiV3EnrollmentProfileChildrenGet200Response addChildrenItem(AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner childrenItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner> getChildren() {
    return children;
  }

  public void setChildren(@javax.annotation.Nullable List<AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner> children) {
    this.children = children;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentProfileChildrenGet200Response abhaApiV3EnrollmentProfileChildrenGet200Response = (AbhaApiV3EnrollmentProfileChildrenGet200Response) o;
    return Objects.equals(this.parentAbhaNumber, abhaApiV3EnrollmentProfileChildrenGet200Response.parentAbhaNumber) &&
        Objects.equals(this.mobileNumber, abhaApiV3EnrollmentProfileChildrenGet200Response.mobileNumber) &&
        Objects.equals(this.childrenCount, abhaApiV3EnrollmentProfileChildrenGet200Response.childrenCount) &&
        Objects.equals(this.children, abhaApiV3EnrollmentProfileChildrenGet200Response.children);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parentAbhaNumber, mobileNumber, childrenCount, children);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentProfileChildrenGet200Response {\n");
    sb.append("    parentAbhaNumber: ").append(toIndentedString(parentAbhaNumber)).append("\n");
  ...
  static {
    ...
    openapiFields.add("parentAbhaNumber");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentProfileChildrenGet200Response is not found in the empty JSON string", AbhaApiV3EnrollmentProfileChildrenGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentProfileChildrenGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("parentAbhaNumber") != null && !jsonObj.get("parentAbhaNumber").isJsonNull()) && !jsonObj.get("parentAbhaNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `parentAbhaNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parentAbhaNumber").toString()));
      }
      ...
      if (jsonObj.get("children") != null && !jsonObj.get("children").isJsonNull()) {
        ...
        if (jsonArraychildren != null) {
          ...
          for (int i = 0; i < jsonArraychildren.size(); i++) {
            AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.validateJsonElement(jsonArraychildren.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentProfileChildrenGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentProfileChildrenGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentProfileChildrenGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentProfileChildrenGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentProfileChildrenGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentProfileChildrenGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentProfileChildrenGet200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet200Response
   */
  public static AbhaApiV3EnrollmentProfileChildrenGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentProfileChildrenGet200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentProfileChildrenGet200Response to an JSON string
   *
   * @return JSON string
   */
