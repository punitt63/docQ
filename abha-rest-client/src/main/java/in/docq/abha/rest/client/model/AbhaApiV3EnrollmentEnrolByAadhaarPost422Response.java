...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost422Response
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost422Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3EnrollmentEnrolByAadhaarPost422ResponseError error;

  public AbhaApiV3EnrollmentEnrolByAadhaarPost422Response() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost422Response error(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost422ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3EnrollmentEnrolByAadhaarPost422ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost422ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost422Response abhaApiV3EnrollmentEnrolByAadhaarPost422Response = (AbhaApiV3EnrollmentEnrolByAadhaarPost422Response) o;
    return Objects.equals(this.error, abhaApiV3EnrollmentEnrolByAadhaarPost422Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost422Response is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3EnrollmentEnrolByAadhaarPost422ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost422Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost422Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost422Response
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost422Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost422Response to an JSON string
   *
   * @return JSON string
   */
