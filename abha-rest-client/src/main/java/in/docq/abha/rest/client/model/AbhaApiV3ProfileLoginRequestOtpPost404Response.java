...
/**
 * AbhaApiV3ProfileLoginRequestOtpPost404Response
 */
...
public class AbhaApiV3ProfileLoginRequestOtpPost404Response {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost404Response() {
  }

  public AbhaApiV3ProfileLoginRequestOtpPost404Response timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost404Response path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost404Response description(@javax.annotation.Nullable String description) {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost404Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost404Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginRequestOtpPost404Response abhaApiV3ProfileLoginRequestOtpPost404Response = (AbhaApiV3ProfileLoginRequestOtpPost404Response) o;
    return Objects.equals(this.timestamp, abhaApiV3ProfileLoginRequestOtpPost404Response.timestamp) &&
        Objects.equals(this.path, abhaApiV3ProfileLoginRequestOtpPost404Response.path) &&
        Objects.equals(this.description, abhaApiV3ProfileLoginRequestOtpPost404Response.description) &&
        Objects.equals(this.error, abhaApiV3ProfileLoginRequestOtpPost404Response.error) &&
        Objects.equals(this.requestId, abhaApiV3ProfileLoginRequestOtpPost404Response.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, path, description, error, requestId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginRequestOtpPost404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginRequestOtpPost404Response is not found in the empty JSON string", AbhaApiV3ProfileLoginRequestOtpPost404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginRequestOtpPost404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginRequestOtpPost404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginRequestOtpPost404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginRequestOtpPost404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost404Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginRequestOtpPost404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginRequestOtpPost404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginRequestOtpPost404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginRequestOtpPost404Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost404Response
   */
  public static AbhaApiV3ProfileLoginRequestOtpPost404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginRequestOtpPost404Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginRequestOtpPost404Response to an JSON string
   *
   * @return JSON string
   */
