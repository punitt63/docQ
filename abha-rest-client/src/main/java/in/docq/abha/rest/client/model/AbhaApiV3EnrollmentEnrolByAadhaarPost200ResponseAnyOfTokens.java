...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens expiresIn(@javax.annotation.Nullable Integer expiresIn) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens refreshExpiresIn(@javax.annotation.Nullable Integer refreshExpiresIn) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens = (AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens) o;
    return Objects.equals(this.token, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.token) &&
        Objects.equals(this.expiresIn, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.expiresIn) &&
        Objects.equals(this.refreshToken, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.refreshToken) &&
        Objects.equals(this.refreshExpiresIn, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.refreshExpiresIn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, expiresIn, refreshToken, refreshExpiresIn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens to an JSON string
   *
   * @return JSON string
   */
