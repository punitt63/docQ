...
/**
 * AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response
 */
...
public class AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response {
  ...
  public static final String SERIALIZED_NAME_INSURANCE_PROGRAMS_LINKED = "insuranceProgramsLinked";
  @SerializedName(SERIALIZED_NAME_INSURANCE_PROGRAMS_LINKED)
  @javax.annotation.Nullable
  private List<String> insuranceProgramsLinked = new ArrayList<>();

  public AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response() {
  }

  public AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response entityType(@javax.annotation.Nullable String entityType) {
  ...
  public AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response insuranceProgramsLinked(@javax.annotation.Nullable List<String> insuranceProgramsLinked) {
    this.insuranceProgramsLinked = insuranceProgramsLinked;
    return this;
  }

  public AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response addInsuranceProgramsLinkedItem(String insuranceProgramsLinkedItem) {
    if (this.insuranceProgramsLinked == null) {
      this.insuranceProgramsLinked = new ArrayList<>();
    }
    this.insuranceProgramsLinked.add(insuranceProgramsLinkedItem);
    return this;
  }

  /**
   * Get insuranceProgramsLinked
   * @return insuranceProgramsLinked
   */
  @javax.annotation.Nullable
  public List<String> getInsuranceProgramsLinked() {
    return insuranceProgramsLinked;
  }

  public void setInsuranceProgramsLinked(@javax.annotation.Nullable List<String> insuranceProgramsLinked) {
    this.insuranceProgramsLinked = insuranceProgramsLinked;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response abhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response = (AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response) o;
    return Objects.equals(this.abhaNumber, abhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.abhaNumber) &&
        Objects.equals(this.entityType, abhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.entityType) &&
        Objects.equals(this.insuranceProgramsLinked, abhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.insuranceProgramsLinked);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaNumber, entityType, insuranceProgramsLinked);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response {\n");
    sb.append("    abhaNumber: ").append(toIndentedString(abhaNumber)).append("\n");
    sb.append("    entityType: ").append(toIndentedString(entityType)).append("\n");
    sb.append("    insuranceProgramsLinked: ").append(toIndentedString(insuranceProgramsLinked)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("insuranceProgramsLinked");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response is not found in the empty JSON string", AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("insuranceProgramsLinked") != null && !jsonObj.get("insuranceProgramsLinked").isJsonNull() && !jsonObj.get("insuranceProgramsLinked").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `insuranceProgramsLinked` to be an array in the JSON string but got `%s`", jsonObj.get("insuranceProgramsLinked").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response
   */
  public static AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitAbhaSearchInsuranceAbhanumberGet200Response to an JSON string
   *
   * @return JSON string
   */
