...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 {
  public static final String SERIALIZED_NAME_BIO = "bio";
  @SerializedName(SERIALIZED_NAME_BIO)
  @javax.annotation.Nullable
  private AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2Bio bio;

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 bio(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2Bio bio) {
    this.bio = bio;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2Bio getBio() {
    return bio;
  }

  public void setBio(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2Bio bio) {
    this.bio = bio;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 = (AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2) o;
    return Objects.equals(this.bio, abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.bio);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `bio`
      if (jsonObj.get("bio") != null && !jsonObj.get("bio").isJsonNull()) {
        AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2Bio.validateJsonElement(jsonObj.get("bio"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner2 to an JSON string
   *
   * @return JSON string
   */
