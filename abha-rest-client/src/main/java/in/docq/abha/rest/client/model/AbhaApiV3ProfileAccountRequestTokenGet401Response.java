...
/**
 * AbhaApiV3ProfileAccountRequestTokenGet401Response
 */
...
public class AbhaApiV3ProfileAccountRequestTokenGet401Response {
  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  @javax.annotation.Nullable
  private AbhaApiV3ProfileAccountAbhaSearchPost401Response value;

  public AbhaApiV3ProfileAccountRequestTokenGet401Response() {
  }

  public AbhaApiV3ProfileAccountRequestTokenGet401Response value(@javax.annotation.Nullable AbhaApiV3ProfileAccountAbhaSearchPost401Response value) {
    this.value = value;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3ProfileAccountAbhaSearchPost401Response getValue() {
    return value;
  }

  public void setValue(@javax.annotation.Nullable AbhaApiV3ProfileAccountAbhaSearchPost401Response value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestTokenGet401Response abhaApiV3ProfileAccountRequestTokenGet401Response = (AbhaApiV3ProfileAccountRequestTokenGet401Response) o;
    return Objects.equals(this.value, abhaApiV3ProfileAccountRequestTokenGet401Response.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountRequestTokenGet401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestTokenGet401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestTokenGet401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestTokenGet401Response is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestTokenGet401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestTokenGet401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestTokenGet401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `value`
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        AbhaApiV3ProfileAccountAbhaSearchPost401Response.validateJsonElement(jsonObj.get("value"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestTokenGet401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestTokenGet401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestTokenGet401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestTokenGet401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestTokenGet401Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestTokenGet401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestTokenGet401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestTokenGet401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestTokenGet401Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestTokenGet401Response
   */
  public static AbhaApiV3ProfileAccountRequestTokenGet401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestTokenGet401Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestTokenGet401Response to an JSON string
   *
   * @return JSON string
   */
