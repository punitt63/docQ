...
/**
 * AbhaApiV3ProfileLoginVerifyUserPost200Response
 */
...
public class AbhaApiV3ProfileLoginVerifyUserPost200Response {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPost200Response() {
  }

  public AbhaApiV3ProfileLoginVerifyUserPost200Response token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginVerifyUserPost200Response expiresIn(@javax.annotation.Nullable Integer expiresIn) {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPost200Response refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPost200Response refreshExpiresIn(@javax.annotation.Nullable Integer refreshExpiresIn) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyUserPost200Response abhaApiV3ProfileLoginVerifyUserPost200Response = (AbhaApiV3ProfileLoginVerifyUserPost200Response) o;
    return Objects.equals(this.token, abhaApiV3ProfileLoginVerifyUserPost200Response.token) &&
        Objects.equals(this.expiresIn, abhaApiV3ProfileLoginVerifyUserPost200Response.expiresIn) &&
        Objects.equals(this.refreshToken, abhaApiV3ProfileLoginVerifyUserPost200Response.refreshToken) &&
        Objects.equals(this.refreshExpiresIn, abhaApiV3ProfileLoginVerifyUserPost200Response.refreshExpiresIn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginVerifyUserPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyUserPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyUserPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyUserPost200Response is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyUserPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyUserPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyUserPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyUserPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyUserPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyUserPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyUserPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyUserPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyUserPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyUserPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyUserPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyUserPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyUserPost200Response
   */
  public static AbhaApiV3ProfileLoginVerifyUserPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyUserPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyUserPost200Response to an JSON string
   *
   * @return JSON string
   */
