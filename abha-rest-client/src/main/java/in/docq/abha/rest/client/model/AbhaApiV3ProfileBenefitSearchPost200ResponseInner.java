...
/**
 * AbhaApiV3ProfileBenefitSearchPost200ResponseInner
 */
...
public class AbhaApiV3ProfileBenefitSearchPost200ResponseInner {
  ...
  public AbhaApiV3ProfileBenefitSearchPost200ResponseInner() {
  }

  public AbhaApiV3ProfileBenefitSearchPost200ResponseInner benefitName(@javax.annotation.Nullable String benefitName) {
  ...
  public AbhaApiV3ProfileBenefitSearchPost200ResponseInner abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public AbhaApiV3ProfileBenefitSearchPost200ResponseInner status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitSearchPost200ResponseInner abhaApiV3ProfileBenefitSearchPost200ResponseInner = (AbhaApiV3ProfileBenefitSearchPost200ResponseInner) o;
    return Objects.equals(this.benefitName, abhaApiV3ProfileBenefitSearchPost200ResponseInner.benefitName) &&
        Objects.equals(this.abhaNumber, abhaApiV3ProfileBenefitSearchPost200ResponseInner.abhaNumber) &&
        Objects.equals(this.status, abhaApiV3ProfileBenefitSearchPost200ResponseInner.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(benefitName, abhaNumber, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileBenefitSearchPost200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitSearchPost200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitSearchPost200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitSearchPost200ResponseInner is not found in the empty JSON string", AbhaApiV3ProfileBenefitSearchPost200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitSearchPost200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitSearchPost200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitSearchPost200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitSearchPost200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitSearchPost200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitSearchPost200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitSearchPost200ResponseInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitSearchPost200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitSearchPost200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitSearchPost200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitSearchPost200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitSearchPost200ResponseInner
   */
  public static AbhaApiV3ProfileBenefitSearchPost200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitSearchPost200ResponseInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitSearchPost200ResponseInner to an JSON string
   *
   * @return JSON string
   */
