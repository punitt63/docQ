...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error error;

  public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 error(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 abhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 = (AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1) o;
    return Objects.equals(this.error, abhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1 to an JSON string
   *
   * @return JSON string
   */
