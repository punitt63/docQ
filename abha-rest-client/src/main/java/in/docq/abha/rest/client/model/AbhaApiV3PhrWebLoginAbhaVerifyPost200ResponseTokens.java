...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens expiresIn(@javax.annotation.Nullable Integer expiresIn) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens refreshExpiresIn(@javax.annotation.Nullable Integer refreshExpiresIn) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens = (AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens) o;
    return Objects.equals(this.token, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.token) &&
        Objects.equals(this.expiresIn, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.expiresIn) &&
        Objects.equals(this.refreshToken, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.refreshToken) &&
        Objects.equals(this.refreshExpiresIn, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.refreshExpiresIn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens to an JSON string
   *
   * @return JSON string
   */
