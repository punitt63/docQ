...
/**
 * AbhaApiV3ProfileAccountAbhaSearchPost404Response
 */
...
public class AbhaApiV3ProfileAccountAbhaSearchPost404Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3ProfileAccountAbhaSearchPost404ResponseError error;

  public AbhaApiV3ProfileAccountAbhaSearchPost404Response() {
  }

  public AbhaApiV3ProfileAccountAbhaSearchPost404Response error(@javax.annotation.Nullable AbhaApiV3ProfileAccountAbhaSearchPost404ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3ProfileAccountAbhaSearchPost404ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3ProfileAccountAbhaSearchPost404ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountAbhaSearchPost404Response abhaApiV3ProfileAccountAbhaSearchPost404Response = (AbhaApiV3ProfileAccountAbhaSearchPost404Response) o;
    return Objects.equals(this.error, abhaApiV3ProfileAccountAbhaSearchPost404Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountAbhaSearchPost404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPost404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPost404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountAbhaSearchPost404Response is not found in the empty JSON string", AbhaApiV3ProfileAccountAbhaSearchPost404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPost404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountAbhaSearchPost404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3ProfileAccountAbhaSearchPost404ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountAbhaSearchPost404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountAbhaSearchPost404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPost404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountAbhaSearchPost404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPost404Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountAbhaSearchPost404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountAbhaSearchPost404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountAbhaSearchPost404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountAbhaSearchPost404Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPost404Response
   */
  public static AbhaApiV3ProfileAccountAbhaSearchPost404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountAbhaSearchPost404Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountAbhaSearchPost404Response to an JSON string
   *
   * @return JSON string
   */
