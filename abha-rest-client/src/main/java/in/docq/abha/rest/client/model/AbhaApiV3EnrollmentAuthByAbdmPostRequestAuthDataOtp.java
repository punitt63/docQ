...
/**
 * AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp
 */
...
public class AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp {
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp() {
  }

  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp txnId(@javax.annotation.Nonnull String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp otpValue(@javax.annotation.Nonnull String otpValue) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp abhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp = (AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp) o;
    return Objects.equals(this.txnId, abhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.txnId) &&
        Objects.equals(this.otpValue, abhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.otpValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp is not found in the empty JSON string", AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp
   */
  public static AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp to an JSON string
   *
   * @return JSON string
   */
