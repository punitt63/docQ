...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner {
  public static final String SERIALIZED_NAME_AUTH_METHODS = "authMethods";
  @SerializedName(SERIALIZED_NAME_AUTH_METHODS)
  @javax.annotation.Nonnull
  private List<String> authMethods = List.of(SERIALIZED_NAME_OTP);

  public static final String SERIALIZED_NAME_OTP = "otp";
  @SerializedName(SERIALIZED_NAME_OTP)
  @javax.annotation.Nullable
  private AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInnerOtp otp;

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner otp(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInnerOtp otp) {
    this.otp = otp;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInnerOtp getOtp() {
    return otp;
  }

  public void setOtp(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInnerOtp otp) {
    this.otp = otp;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner = (AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner) o;
    return Objects.equals(this.otp, abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.otp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `otp`
      if (jsonObj.get("otp") != null && !jsonObj.get("otp").isJsonNull()) {
        AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInnerOtp.validateJsonElement(jsonObj.get("otp"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner to an JSON string
   *
   * @return JSON string
   */
