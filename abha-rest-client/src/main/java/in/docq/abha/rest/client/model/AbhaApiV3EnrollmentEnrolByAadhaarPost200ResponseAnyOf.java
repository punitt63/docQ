...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf {
  ...
  @javax.annotation.Nullable
  private AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens tokens;

  public static final String SERIALIZED_NAME_AB_H_A_PROFILE = "ABHAProfile";
  @SerializedName(SERIALIZED_NAME_AB_H_A_PROFILE)
  @javax.annotation.Nullable
  private AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfABHAProfile abHAProfile;
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf tokens(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens tokens) {
    this.tokens = tokens;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens getTokens() {
    return tokens;
  }

  public void setTokens(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens tokens) {
    this.tokens = tokens;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf abHAProfile(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfABHAProfile abHAProfile) {
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfABHAProfile getAbHAProfile() {
    return abHAProfile;
  }

  public void setAbHAProfile(@javax.annotation.Nullable AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfABHAProfile abHAProfile) {
    this.abHAProfile = abHAProfile;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf isNew(@javax.annotation.Nullable Boolean isNew) {
    this.isNew = isNew;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf = (AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf) o;
    return Objects.equals(this.message, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.message) &&
        Objects.equals(this.tokens, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.tokens) &&
        Objects.equals(this.abHAProfile, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.abHAProfile) &&
        Objects.equals(this.isNew, abhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.isNew);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, tokens, abHAProfile, isNew);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf {\n");
    sb.append("    message: ").append(toIndentedString(message)).append("\n");
    sb.append("    tokens: ").append(toIndentedString(tokens)).append("\n");
    sb.append("    abHAProfile: ").append(toIndentedString(abHAProfile)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("tokens") != null && !jsonObj.get("tokens").isJsonNull()) {
        AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfTokens.validateJsonElement(jsonObj.get("tokens"));
      }
      // validate the optional field `ABHAProfile`
      if (jsonObj.get("ABHAProfile") != null && !jsonObj.get("ABHAProfile").isJsonNull()) {
        AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOfABHAProfile.validateJsonElement(jsonObj.get("ABHAProfile"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost200ResponseAnyOf to an JSON string
   *
   * @return JSON string
   */
