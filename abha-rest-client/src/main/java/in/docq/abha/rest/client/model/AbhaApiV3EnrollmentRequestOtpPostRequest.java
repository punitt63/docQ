...
/**
 * AbhaApiV3EnrollmentRequestOtpPostRequest
 */
...
public class AbhaApiV3EnrollmentRequestOtpPostRequest {
  ...
  public AbhaApiV3EnrollmentRequestOtpPostRequest() {
  }

  public AbhaApiV3EnrollmentRequestOtpPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentRequestOtpPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3EnrollmentRequestOtpPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public AbhaApiV3EnrollmentRequestOtpPostRequest otpSystem(@javax.annotation.Nonnull String otpSystem) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentRequestOtpPostRequest abhaApiV3EnrollmentRequestOtpPostRequest = (AbhaApiV3EnrollmentRequestOtpPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3EnrollmentRequestOtpPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3EnrollmentRequestOtpPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3EnrollmentRequestOtpPostRequest.loginId) &&
        Objects.equals(this.otpSystem, abhaApiV3EnrollmentRequestOtpPostRequest.otpSystem);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentRequestOtpPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentRequestOtpPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentRequestOtpPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentRequestOtpPostRequest is not found in the empty JSON string", AbhaApiV3EnrollmentRequestOtpPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentRequestOtpPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentRequestOtpPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentRequestOtpPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentRequestOtpPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentRequestOtpPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentRequestOtpPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentRequestOtpPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentRequestOtpPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentRequestOtpPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentRequestOtpPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentRequestOtpPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentRequestOtpPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentRequestOtpPostRequest
   */
  public static AbhaApiV3EnrollmentRequestOtpPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentRequestOtpPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentRequestOtpPostRequest to an JSON string
   *
   * @return JSON string
   */
