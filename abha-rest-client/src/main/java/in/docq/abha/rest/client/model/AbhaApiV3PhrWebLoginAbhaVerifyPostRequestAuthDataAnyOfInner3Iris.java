...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris {
  public static final String SERIALIZED_NAME_TXN_ID = "txnId";
  @SerializedName(SERIALIZED_NAME_TXN_ID)
  @javax.annotation.Nullable
  private String txnId;

  public static final String SERIALIZED_NAME_IRIS_AUTH_PID = "irisAuthPid";
  @SerializedName(SERIALIZED_NAME_IRIS_AUTH_PID)
  @javax.annotation.Nullable
  private String irisAuthPid;

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris irisAuthPid(@javax.annotation.Nullable String irisAuthPid) {
    this.irisAuthPid = irisAuthPid;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getIrisAuthPid() {
    return irisAuthPid;
  }

  public void setIrisAuthPid(@javax.annotation.Nullable String irisAuthPid) {
    this.irisAuthPid = irisAuthPid;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris = (AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris) o;
    return Objects.equals(this.txnId, abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.txnId) &&
        Objects.equals(this.irisAuthPid, abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.irisAuthPid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, irisAuthPid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris {\n");
    sb.append("    txnId: ").append(toIndentedString(txnId)).append("\n");
    sb.append("    irisAuthPid: ").append(toIndentedString(irisAuthPid)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("irisAuthPid") != null && !jsonObj.get("irisAuthPid").isJsonNull()) && !jsonObj.get("irisAuthPid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `irisAuthPid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("irisAuthPid").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris to an JSON string
   *
   * @return JSON string
   */
