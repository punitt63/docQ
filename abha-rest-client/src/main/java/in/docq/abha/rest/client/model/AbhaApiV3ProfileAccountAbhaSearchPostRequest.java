...
/**
 * AbhaApiV3ProfileAccountAbhaSearchPostRequest
 */
...
public class AbhaApiV3ProfileAccountAbhaSearchPostRequest {
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPostRequest() {
  }

  public AbhaApiV3ProfileAccountAbhaSearchPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileAccountAbhaSearchPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPostRequest mobile(@javax.annotation.Nonnull String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountAbhaSearchPostRequest abhaApiV3ProfileAccountAbhaSearchPostRequest = (AbhaApiV3ProfileAccountAbhaSearchPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileAccountAbhaSearchPostRequest.scope) &&
        Objects.equals(this.mobile, abhaApiV3ProfileAccountAbhaSearchPostRequest.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, mobile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountAbhaSearchPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountAbhaSearchPostRequest is not found in the empty JSON string", AbhaApiV3ProfileAccountAbhaSearchPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountAbhaSearchPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountAbhaSearchPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountAbhaSearchPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountAbhaSearchPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountAbhaSearchPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountAbhaSearchPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountAbhaSearchPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountAbhaSearchPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountAbhaSearchPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPostRequest
   */
  public static AbhaApiV3ProfileAccountAbhaSearchPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountAbhaSearchPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountAbhaSearchPostRequest to an JSON string
   *
   * @return JSON string
   */
