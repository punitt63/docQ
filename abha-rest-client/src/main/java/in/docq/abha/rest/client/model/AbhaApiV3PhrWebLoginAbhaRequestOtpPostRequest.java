...
/**
 * AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest
 */
...
public class AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest() {
  }

  public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest otpSystem(@javax.annotation.Nonnull String otpSystem) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest abhaApiV3PhrWebLoginAbhaRequestOtpPostRequest = (AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.loginId) &&
        Objects.equals(this.otpSystem, abhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.otpSystem);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest
   */
  public static AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPostRequest to an JSON string
   *
   * @return JSON string
   */
