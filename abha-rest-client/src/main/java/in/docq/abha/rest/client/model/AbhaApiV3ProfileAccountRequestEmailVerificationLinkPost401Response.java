...
/**
 * AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response
 */
...
public class AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response() {
  }

  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response abhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response = (AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response) o;
    return Objects.equals(this.code, abhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.code) &&
        Objects.equals(this.message, abhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.message) &&
        Objects.equals(this.description, abhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response
   */
  public static AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost401Response to an JSON string
   *
   * @return JSON string
   */
