...
/**
 * AbhaApiV3ProfilePublicCertificateGet400Response
 */
...
public class AbhaApiV3ProfilePublicCertificateGet400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3ProfilePublicCertificateGet400ResponseError error;

  public AbhaApiV3ProfilePublicCertificateGet400Response() {
  }

  public AbhaApiV3ProfilePublicCertificateGet400Response error(@javax.annotation.Nullable AbhaApiV3ProfilePublicCertificateGet400ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3ProfilePublicCertificateGet400ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3ProfilePublicCertificateGet400ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfilePublicCertificateGet400Response abhaApiV3ProfilePublicCertificateGet400Response = (AbhaApiV3ProfilePublicCertificateGet400Response) o;
    return Objects.equals(this.error, abhaApiV3ProfilePublicCertificateGet400Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfilePublicCertificateGet400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfilePublicCertificateGet400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfilePublicCertificateGet400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfilePublicCertificateGet400Response is not found in the empty JSON string", AbhaApiV3ProfilePublicCertificateGet400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfilePublicCertificateGet400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfilePublicCertificateGet400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3ProfilePublicCertificateGet400ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfilePublicCertificateGet400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfilePublicCertificateGet400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfilePublicCertificateGet400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfilePublicCertificateGet400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfilePublicCertificateGet400Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfilePublicCertificateGet400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfilePublicCertificateGet400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfilePublicCertificateGet400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfilePublicCertificateGet400Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfilePublicCertificateGet400Response
   */
  public static AbhaApiV3ProfilePublicCertificateGet400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfilePublicCertificateGet400Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfilePublicCertificateGet400Response to an JSON string
   *
   * @return JSON string
   */
