...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPostRequest
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPostRequest {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthData authData;

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequest() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequest authData(@javax.annotation.Nonnull AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthData authData) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthData getAuthData() {
    return authData;
  }

  public void setAuthData(@javax.annotation.Nonnull AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthData authData) {
    this.authData = authData;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPostRequest abhaApiV3PhrWebLoginAbhaVerifyPostRequest = (AbhaApiV3PhrWebLoginAbhaVerifyPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3PhrWebLoginAbhaVerifyPostRequest.scope) &&
        Objects.equals(this.authData, abhaApiV3PhrWebLoginAbhaVerifyPostRequest.authData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, authData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPostRequest is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.openapiRequiredFields) {
      ...
      AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthData.validateJsonElement(jsonObj.get("authData"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequest
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequest to an JSON string
   *
   * @return JSON string
   */
