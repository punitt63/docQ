...
/**
 * AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1
 */
...
public class AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 {
  ...
  public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1() {
  }

  public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 password(@javax.annotation.Nullable String password) {
  ...
  public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 abhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 = (AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1) o;
    return Objects.equals(this.password, abhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.password) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1
   */
  public static AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner1 to an JSON string
   *
   * @return JSON string
   */
