...
/**
 * AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner
 */
...
public class AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner {
  public static final String SERIALIZED_NAME_TXN_ID = "txnId";
  @SerializedName(SERIALIZED_NAME_TXN_ID)
  @javax.annotation.Nullable
  private String txnId;

  public static final String SERIALIZED_NAME_A_B_H_A = "ABHA";
  @SerializedName(SERIALIZED_NAME_A_B_H_A)
  @javax.annotation.Nullable
  private List<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner> ABHA = new ArrayList<>();

  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner() {
  }

  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner ABHA(@javax.annotation.Nullable List<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner> ABHA) {
    this.ABHA = ABHA;
    return this;
  }

  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner addABHAItem(AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner ABHAItem) {
    if (this.ABHA == null) {
      this.ABHA = new ArrayList<>();
    }
    this.ABHA.add(ABHAItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner> getABHA() {
    return ABHA;
  }

  public void setABHA(@javax.annotation.Nullable List<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner> ABHA) {
    this.ABHA = ABHA;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner abhaApiV3ProfileAccountAbhaSearchPost200ResponseInner = (AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner) o;
    return Objects.equals(this.txnId, abhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.txnId) &&
        Objects.equals(this.ABHA, abhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.ABHA);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, ABHA);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner {\n");
    sb.append("    txnId: ").append(toIndentedString(txnId)).append("\n");
    sb.append("    ABHA: ").append(toIndentedString(ABHA)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner is not found in the empty JSON string", AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ABHA") != null && !jsonObj.get("ABHA").isJsonNull()) {
        JsonArray jsonArrayABHA = jsonObj.getAsJsonArray("ABHA");
        if (jsonArrayABHA != null) {
          // ensure the json data is an array
          if (!jsonObj.get("ABHA").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `ABHA` to be an array in the JSON string but got `%s`", jsonObj.get("ABHA").toString()));
          }

          // validate the optional field `ABHA` (array)
          for (int i = 0; i < jsonArrayABHA.size(); i++) {
            AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.validateJsonElement(jsonArrayABHA.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner
   */
  public static AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInner to an JSON string
   *
   * @return JSON string
   */
