...
/**
 * AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response
 */
...
public class AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response abhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response = (AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response) o;
    return Objects.equals(this.txnId, abhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.txnId) &&
        Objects.equals(this.message, abhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response
   */
  public static AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPost200Response to an JSON string
   *
   * @return JSON string
   */
