...
public class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOfOtp otp;

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf otp(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOfOtp otp) {
    this.otp = otp;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOfOtp getOtp() {
    return otp;
  }
  ...
  public void setOtp(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOfOtp otp) {
    this.otp = otp;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf = (AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf) o;
    return Objects.equals(this.otp, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.otp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.openapiRequiredFields) {
      ...
      AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOfOtp.validateJsonElement(jsonObj.get("otp"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf to an JSON string
   *
   * @return JSON string
   */
