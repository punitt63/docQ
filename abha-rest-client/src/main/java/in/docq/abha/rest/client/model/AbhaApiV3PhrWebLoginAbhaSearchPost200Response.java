...
/**
 * AbhaApiV3PhrWebLoginAbhaSearchPost200Response
 */
...
public class AbhaApiV3PhrWebLoginAbhaSearchPost200Response {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response() {
  }

  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response healthIdNumber(@javax.annotation.Nullable String healthIdNumber) {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response abhaAddress(@javax.annotation.Nullable String abhaAddress) {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response authMethods(@javax.annotation.Nullable List<String> authMethods) {
    this.authMethods = authMethods;
    return this;
  }

  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response addAuthMethodsItem(String authMethodsItem) {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response blockedAuthMethods(@javax.annotation.Nullable List<String> blockedAuthMethods) {
    this.blockedAuthMethods = blockedAuthMethods;
    return this;
  }

  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response addBlockedAuthMethodsItem(String blockedAuthMethodsItem) {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response fullName(@javax.annotation.Nullable String fullName) {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost200Response mobile(@javax.annotation.Nullable String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaSearchPost200Response abhaApiV3PhrWebLoginAbhaSearchPost200Response = (AbhaApiV3PhrWebLoginAbhaSearchPost200Response) o;
    return Objects.equals(this.healthIdNumber, abhaApiV3PhrWebLoginAbhaSearchPost200Response.healthIdNumber) &&
        Objects.equals(this.abhaAddress, abhaApiV3PhrWebLoginAbhaSearchPost200Response.abhaAddress) &&
        Objects.equals(this.authMethods, abhaApiV3PhrWebLoginAbhaSearchPost200Response.authMethods) &&
        Objects.equals(this.blockedAuthMethods, abhaApiV3PhrWebLoginAbhaSearchPost200Response.blockedAuthMethods) &&
        Objects.equals(this.status, abhaApiV3PhrWebLoginAbhaSearchPost200Response.status) &&
        Objects.equals(this.message, abhaApiV3PhrWebLoginAbhaSearchPost200Response.message) &&
        Objects.equals(this.fullName, abhaApiV3PhrWebLoginAbhaSearchPost200Response.fullName) &&
        Objects.equals(this.mobile, abhaApiV3PhrWebLoginAbhaSearchPost200Response.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(healthIdNumber, abhaAddress, authMethods, blockedAuthMethods, status, message, fullName, mobile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3PhrWebLoginAbhaSearchPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaSearchPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaSearchPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaSearchPost200Response is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaSearchPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaSearchPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaSearchPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaSearchPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaSearchPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaSearchPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaSearchPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaSearchPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaSearchPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaSearchPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaSearchPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaSearchPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaSearchPost200Response
   */
  public static AbhaApiV3PhrWebLoginAbhaSearchPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaSearchPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaSearchPost200Response to an JSON string
   *
   * @return JSON string
   */
