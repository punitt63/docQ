...
/**
 * AbhaApiV3EnrollmentRequestOtpPost500Response
 */
...
public class AbhaApiV3EnrollmentRequestOtpPost500Response {
  ...
  public AbhaApiV3EnrollmentRequestOtpPost500Response() {
  }

  public AbhaApiV3EnrollmentRequestOtpPost500Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentRequestOtpPost500Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3EnrollmentRequestOtpPost500Response description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentRequestOtpPost500Response abhaApiV3EnrollmentRequestOtpPost500Response = (AbhaApiV3EnrollmentRequestOtpPost500Response) o;
    return Objects.equals(this.code, abhaApiV3EnrollmentRequestOtpPost500Response.code) &&
        Objects.equals(this.message, abhaApiV3EnrollmentRequestOtpPost500Response.message) &&
        Objects.equals(this.description, abhaApiV3EnrollmentRequestOtpPost500Response.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentRequestOtpPost500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentRequestOtpPost500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentRequestOtpPost500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentRequestOtpPost500Response is not found in the empty JSON string", AbhaApiV3EnrollmentRequestOtpPost500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentRequestOtpPost500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentRequestOtpPost500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentRequestOtpPost500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentRequestOtpPost500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentRequestOtpPost500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentRequestOtpPost500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentRequestOtpPost500Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentRequestOtpPost500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentRequestOtpPost500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentRequestOtpPost500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentRequestOtpPost500Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentRequestOtpPost500Response
   */
  public static AbhaApiV3EnrollmentRequestOtpPost500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentRequestOtpPost500Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentRequestOtpPost500Response to an JSON string
   *
   * @return JSON string
   */
