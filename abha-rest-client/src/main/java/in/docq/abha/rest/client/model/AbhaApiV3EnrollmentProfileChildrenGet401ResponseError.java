...
/**
 * AbhaApiV3EnrollmentProfileChildrenGet401ResponseError
 */
...
public class AbhaApiV3EnrollmentProfileChildrenGet401ResponseError {
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet401ResponseError() {
  }

  public AbhaApiV3EnrollmentProfileChildrenGet401ResponseError code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet401ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentProfileChildrenGet401ResponseError abhaApiV3EnrollmentProfileChildrenGet401ResponseError = (AbhaApiV3EnrollmentProfileChildrenGet401ResponseError) o;
    return Objects.equals(this.code, abhaApiV3EnrollmentProfileChildrenGet401ResponseError.code) &&
        Objects.equals(this.message, abhaApiV3EnrollmentProfileChildrenGet401ResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentProfileChildrenGet401ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet401ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentProfileChildrenGet401ResponseError is not found in the empty JSON string", AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentProfileChildrenGet401ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentProfileChildrenGet401ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet401ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet401ResponseError>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentProfileChildrenGet401ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentProfileChildrenGet401ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentProfileChildrenGet401ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentProfileChildrenGet401ResponseError
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet401ResponseError
   */
  public static AbhaApiV3EnrollmentProfileChildrenGet401ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentProfileChildrenGet401ResponseError to an JSON string
   *
   * @return JSON string
   */
