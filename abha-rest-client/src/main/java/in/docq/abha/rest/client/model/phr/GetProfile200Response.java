...
public class GetProfile200Response {
  ...
  public static final String SERIALIZED_NAME_PROFILE_PHOTO_FILE = "profilePhotoFile";
  @SerializedName(SERIALIZED_NAME_PROFILE_PHOTO_FILE)
  @javax.annotation.Nullable
  ...
  public GetProfile200Response abhaAddress(@javax.annotation.Nullable String abhaAddress) {
  ...
  public GetProfile200Response abhaLinkedCount(@javax.annotation.Nullable String abhaLinkedCount) {
  ...
  public GetProfile200Response abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public GetProfile200Response authMethods(@javax.annotation.Nullable List<String> authMethods) {
    this.authMethods = authMethods;
    return this;
  }

  public GetProfile200Response addAuthMethodsItem(String authMethodsItem) {
  ...
  public GetProfile200Response dateOfBirth(@javax.annotation.Nullable String dateOfBirth) {
  ...
  public GetProfile200Response dayOfBirth(@javax.annotation.Nullable String dayOfBirth) {
  ...
  public GetProfile200Response districtCode(@javax.annotation.Nullable String districtCode) {
  ...
  public GetProfile200Response districtName(@javax.annotation.Nullable String districtName) {
  ...
  public GetProfile200Response email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public GetProfile200Response emailVerified(@javax.annotation.Nullable String emailVerified) {
  ...
  public GetProfile200Response firstName(@javax.annotation.Nullable String firstName) {
  ...
  public GetProfile200Response fullName(@javax.annotation.Nullable String fullName) {
  ...
  public GetProfile200Response gender(@javax.annotation.Nullable String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public GetProfile200Response kycStatus(@javax.annotation.Nullable String kycStatus) {
  ...
  public GetProfile200Response lastName(@javax.annotation.Nullable String lastName) {
  ...
  public GetProfile200Response middleName(@javax.annotation.Nullable String middleName) {
  ...
  public GetProfile200Response mobile(@javax.annotation.Nullable String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public GetProfile200Response mobileVerified(@javax.annotation.Nullable String mobileVerified) {
  ...
  public GetProfile200Response monthOfBirth(@javax.annotation.Nullable String monthOfBirth) {
  ...
  public GetProfile200Response pinCode(@javax.annotation.Nullable String pinCode) {
  ...
  public GetProfile200Response stateCode(@javax.annotation.Nullable String stateCode) {
  ...
  public GetProfile200Response stateName(@javax.annotation.Nullable String stateName) {
  ...
  public GetProfile200Response status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public GetProfile200Response yearOfBirth(@javax.annotation.Nullable String yearOfBirth) {
  ...
  public GetProfile200Response profilePhoto(@javax.annotation.Nullable String profilePhoto) {
  ...
  public GetProfile200Response townName(@javax.annotation.Nullable String townName) {
  ...
  public GetProfile200Response profilePhotoFile(@javax.annotation.Nullable String profilePhotoFile) {
    this.profilePhotoFile = profilePhotoFile;
    return this;
  }

  /**
   * Get profilePhotoFile
  ...
  public void setProfilePhotoFile(@javax.annotation.Nullable String profilePhotoFile) {
    this.profilePhotoFile = profilePhotoFile;
  }

  public GetProfile200Response preferredAbhaAddress(@javax.annotation.Nullable String preferredAbhaAddress) {
  ...
  public GetProfile200Response age(@javax.annotation.Nullable Integer age) {
    this.age = age;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.abhaAddress, getProfile200Response.abhaAddress) &&
        Objects.equals(this.abhaLinkedCount, getProfile200Response.abhaLinkedCount) &&
        Objects.equals(this.abhaNumber, getProfile200Response.abhaNumber) &&
        Objects.equals(this.address, getProfile200Response.address) &&
        Objects.equals(this.authMethods, getProfile200Response.authMethods) &&
        Objects.equals(this.dateOfBirth, getProfile200Response.dateOfBirth) &&
        Objects.equals(this.dayOfBirth, getProfile200Response.dayOfBirth) &&
        Objects.equals(this.districtCode, getProfile200Response.districtCode) &&
        Objects.equals(this.districtName, getProfile200Response.districtName) &&
        Objects.equals(this.email, getProfile200Response.email) &&
        Objects.equals(this.emailVerified, getProfile200Response.emailVerified) &&
        Objects.equals(this.firstName, getProfile200Response.firstName) &&
        Objects.equals(this.fullName, getProfile200Response.fullName) &&
        Objects.equals(this.gender, getProfile200Response.gender) &&
        Objects.equals(this.kycStatus, getProfile200Response.kycStatus) &&
        Objects.equals(this.lastName, getProfile200Response.lastName) &&
        Objects.equals(this.middleName, getProfile200Response.middleName) &&
        Objects.equals(this.mobile, getProfile200Response.mobile) &&
        Objects.equals(this.mobileVerified, getProfile200Response.mobileVerified) &&
        Objects.equals(this.monthOfBirth, getProfile200Response.monthOfBirth) &&
        Objects.equals(this.pinCode, getProfile200Response.pinCode) &&
        Objects.equals(this.stateCode, getProfile200Response.stateCode) &&
        Objects.equals(this.stateName, getProfile200Response.stateName) &&
        Objects.equals(this.status, getProfile200Response.status) &&
        Objects.equals(this.yearOfBirth, getProfile200Response.yearOfBirth) &&
        Objects.equals(this.profilePhoto, getProfile200Response.profilePhoto) &&
        Objects.equals(this.townName, getProfile200Response.townName) &&
        Objects.equals(this.profilePhotoFile, getProfile200Response.profilePhotoFile) &&
        Objects.equals(this.preferredAbhaAddress, getProfile200Response.preferredAbhaAddress) &&
        Objects.equals(this.age, getProfile200Response.age);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaAddress, abhaLinkedCount, abhaNumber, address, authMethods, dateOfBirth, dayOfBirth, districtCode, districtName, email, emailVerified, firstName, fullName, gender, kycStatus, lastName, middleName, mobile, mobileVerified, monthOfBirth, pinCode, stateCode, stateName, status, yearOfBirth, profilePhoto, townName, profilePhotoFile, preferredAbhaAddress, age);
  }
  ...
  public String toString() {
    ...
    sb.append("    profilePhotoFile: ").append(toIndentedString(profilePhotoFile)).append("\n");
  ...
  static {
    ...
    openapiFields.add("profilePhotoFile");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProfile200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProfile200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProfile200Response is not found in the empty JSON string", GetProfile200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProfile200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProfile200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProfile200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProfile200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProfile200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProfile200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProfile200Response>() {
           @Override
           public void write(JsonWriter out, GetProfile200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProfile200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProfile200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProfile200Response
   * @throws IOException if the JSON string is invalid with respect to GetProfile200Response
   */
  public static GetProfile200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProfile200Response.class);
  }

  /**
   * Convert an instance of GetProfile200Response to an JSON string
   *
   * @return JSON string
   */
