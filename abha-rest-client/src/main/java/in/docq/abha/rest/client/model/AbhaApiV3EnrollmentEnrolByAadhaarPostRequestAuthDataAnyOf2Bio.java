...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio {
  public static final String SERIALIZED_NAME_AADHAAR = "aadhaar";
  @SerializedName(SERIALIZED_NAME_AADHAAR)
  @javax.annotation.Nonnull
  private String aadhaar;

  public static final String SERIALIZED_NAME_FINGER_PRINT_AUTH_PID = "fingerPrintAuthPid";
  @SerializedName(SERIALIZED_NAME_FINGER_PRINT_AUTH_PID)
  @javax.annotation.Nonnull
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio aadhaar(@javax.annotation.Nonnull String aadhaar) {
  ...
  public void setAadhaar(@javax.annotation.Nonnull String aadhaar) {
    this.aadhaar = aadhaar;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio fingerPrintAuthPid(@javax.annotation.Nonnull String fingerPrintAuthPid) {
    this.fingerPrintAuthPid = fingerPrintAuthPid;
    return this;
  }

  /**
   * Get fingerPrintAuthPid
   * @return fingerPrintAuthPid
   */
  @javax.annotation.Nonnull
  public String getFingerPrintAuthPid() {
    return fingerPrintAuthPid;
  }

  public void setFingerPrintAuthPid(@javax.annotation.Nonnull String fingerPrintAuthPid) {
    this.fingerPrintAuthPid = fingerPrintAuthPid;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio mobile(@javax.annotation.Nonnull String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio = (AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio) o;
    return Objects.equals(this.aadhaar, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.aadhaar) &&
        Objects.equals(this.fingerPrintAuthPid, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.fingerPrintAuthPid) &&
        Objects.equals(this.mobile, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aadhaar, fingerPrintAuthPid, mobile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio {\n");
    sb.append("    aadhaar: ").append(toIndentedString(aadhaar)).append("\n");
    sb.append("    fingerPrintAuthPid: ").append(toIndentedString(fingerPrintAuthPid)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fingerPrintAuthPid");
    openapiFields.add("mobile");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("aadhaar");
    openapiRequiredFields.add("fingerPrintAuthPid");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("aadhaar").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("fingerPrintAuthPid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fingerPrintAuthPid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fingerPrintAuthPid").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf2Bio to an JSON string
   *
   * @return JSON string
   */
