...
/**
 * AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5
 */
...
public class AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5() {
  }

  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 loginId(@javax.annotation.Nullable String loginId) {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 = (AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5) o;
    return Objects.equals(this.loginId, abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.loginId) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loginId, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 is not found in the empty JSON string", AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5
   */
  public static AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner5 to an JSON string
   *
   * @return JSON string
   */
