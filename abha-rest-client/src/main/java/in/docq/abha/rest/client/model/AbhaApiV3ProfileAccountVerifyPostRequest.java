...
/**
 * AbhaApiV3ProfileAccountVerifyPostRequest
 */
...
public class AbhaApiV3ProfileAccountVerifyPostRequest {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3ProfileAccountVerifyPostRequestAuthData authData;
  ...
  public AbhaApiV3ProfileAccountVerifyPostRequest() {
  }

  public AbhaApiV3ProfileAccountVerifyPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileAccountVerifyPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileAccountVerifyPostRequest authData(@javax.annotation.Nonnull AbhaApiV3ProfileAccountVerifyPostRequestAuthData authData) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3ProfileAccountVerifyPostRequestAuthData getAuthData() {
    return authData;
  }

  public void setAuthData(@javax.annotation.Nonnull AbhaApiV3ProfileAccountVerifyPostRequestAuthData authData) {
    this.authData = authData;
  }


  public AbhaApiV3ProfileAccountVerifyPostRequest reasons(@javax.annotation.Nonnull List<String> reasons) {
    this.reasons = reasons;
    return this;
  }

  public AbhaApiV3ProfileAccountVerifyPostRequest addReasonsItem(String reasonsItem) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPostRequest abhaApiV3ProfileAccountVerifyPostRequest = (AbhaApiV3ProfileAccountVerifyPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileAccountVerifyPostRequest.scope) &&
        Objects.equals(this.authData, abhaApiV3ProfileAccountVerifyPostRequest.authData) &&
        Objects.equals(this.reasons, abhaApiV3ProfileAccountVerifyPostRequest.reasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, authData, reasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountVerifyPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPostRequest is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountVerifyPostRequest.openapiRequiredFields) {
      ...
      AbhaApiV3ProfileAccountVerifyPostRequestAuthData.validateJsonElement(jsonObj.get("authData"));
      // ensure the required json array is present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPostRequest
   */
  public static AbhaApiV3ProfileAccountVerifyPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPostRequest to an JSON string
   *
   * @return JSON string
   */
