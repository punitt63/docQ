...
/**
 * ApiHiecmGatewayV3SessionsPost400Response
 */
...
public class ApiHiecmGatewayV3SessionsPost400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private ApiHiecmGatewayV3SessionsPost400ResponseError error;

  public ApiHiecmGatewayV3SessionsPost400Response() {
  }

  public ApiHiecmGatewayV3SessionsPost400Response error(@javax.annotation.Nullable ApiHiecmGatewayV3SessionsPost400ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ApiHiecmGatewayV3SessionsPost400ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable ApiHiecmGatewayV3SessionsPost400ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiHiecmGatewayV3SessionsPost400Response apiHiecmGatewayV3SessionsPost400Response = (ApiHiecmGatewayV3SessionsPost400Response) o;
    return Objects.equals(this.error, apiHiecmGatewayV3SessionsPost400Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiHiecmGatewayV3SessionsPost400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiHiecmGatewayV3SessionsPost400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiHiecmGatewayV3SessionsPost400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiHiecmGatewayV3SessionsPost400Response is not found in the empty JSON string", ApiHiecmGatewayV3SessionsPost400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiHiecmGatewayV3SessionsPost400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiHiecmGatewayV3SessionsPost400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        ApiHiecmGatewayV3SessionsPost400ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiHiecmGatewayV3SessionsPost400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiHiecmGatewayV3SessionsPost400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiHiecmGatewayV3SessionsPost400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiHiecmGatewayV3SessionsPost400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiHiecmGatewayV3SessionsPost400Response>() {
           @Override
           public void write(JsonWriter out, ApiHiecmGatewayV3SessionsPost400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiHiecmGatewayV3SessionsPost400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiHiecmGatewayV3SessionsPost400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiHiecmGatewayV3SessionsPost400Response
   * @throws IOException if the JSON string is invalid with respect to ApiHiecmGatewayV3SessionsPost400Response
   */
  public static ApiHiecmGatewayV3SessionsPost400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiHiecmGatewayV3SessionsPost400Response.class);
  }

  /**
   * Convert an instance of ApiHiecmGatewayV3SessionsPost400Response to an JSON string
   *
   * @return JSON string
   */
