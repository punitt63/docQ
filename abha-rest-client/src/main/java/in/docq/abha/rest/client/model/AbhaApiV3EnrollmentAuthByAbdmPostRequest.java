...
/**
 * AbhaApiV3EnrollmentAuthByAbdmPostRequest
 */
...
public class AbhaApiV3EnrollmentAuthByAbdmPostRequest {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData authData;

  public AbhaApiV3EnrollmentAuthByAbdmPostRequest() {
  }

  public AbhaApiV3EnrollmentAuthByAbdmPostRequest scope(@javax.annotation.Nonnull String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPostRequest authData(@javax.annotation.Nonnull AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData authData) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData getAuthData() {
    return authData;
  }

  public void setAuthData(@javax.annotation.Nonnull AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData authData) {
    this.authData = authData;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentAuthByAbdmPostRequest abhaApiV3EnrollmentAuthByAbdmPostRequest = (AbhaApiV3EnrollmentAuthByAbdmPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3EnrollmentAuthByAbdmPostRequest.scope) &&
        Objects.equals(this.authData, abhaApiV3EnrollmentAuthByAbdmPostRequest.authData);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentAuthByAbdmPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentAuthByAbdmPostRequest is not found in the empty JSON string", AbhaApiV3EnrollmentAuthByAbdmPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentAuthByAbdmPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentAuthByAbdmPostRequest.openapiRequiredFields) {
      ...
      AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.validateJsonElement(jsonObj.get("authData"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentAuthByAbdmPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentAuthByAbdmPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentAuthByAbdmPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentAuthByAbdmPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentAuthByAbdmPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentAuthByAbdmPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentAuthByAbdmPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPostRequest
   */
  public static AbhaApiV3EnrollmentAuthByAbdmPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentAuthByAbdmPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentAuthByAbdmPostRequest to an JSON string
   *
   * @return JSON string
   */
