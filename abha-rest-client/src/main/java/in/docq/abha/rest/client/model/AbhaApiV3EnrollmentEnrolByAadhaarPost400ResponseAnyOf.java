...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf = (AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf) o;
    return Objects.equals(this.txnId, abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.txnId) &&
        Objects.equals(this.timestamp, abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf to an JSON string
   *
   * @return JSON string
   */
