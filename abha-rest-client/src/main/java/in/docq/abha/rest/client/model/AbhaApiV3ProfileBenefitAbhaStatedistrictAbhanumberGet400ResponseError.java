...
/**
 * AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError
 */
...
public class AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError {
  ...
  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError() {
  }

  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError = (AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError) o;
    return Objects.equals(this.code, abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.code) &&
        Objects.equals(this.message, abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError is not found in the empty JSON string", AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError
   */
  public static AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet400ResponseError to an JSON string
   *
   * @return JSON string
   */
