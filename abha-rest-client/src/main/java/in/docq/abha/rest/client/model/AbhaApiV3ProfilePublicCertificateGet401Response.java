...
/**
 * AbhaApiV3ProfilePublicCertificateGet401Response
 */
...
public class AbhaApiV3ProfilePublicCertificateGet401Response {
  ...
  public AbhaApiV3ProfilePublicCertificateGet401Response() {
  }

  public AbhaApiV3ProfilePublicCertificateGet401Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3ProfilePublicCertificateGet401Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfilePublicCertificateGet401Response example(@javax.annotation.Nullable String example) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfilePublicCertificateGet401Response abhaApiV3ProfilePublicCertificateGet401Response = (AbhaApiV3ProfilePublicCertificateGet401Response) o;
    return Objects.equals(this.code, abhaApiV3ProfilePublicCertificateGet401Response.code) &&
        Objects.equals(this.message, abhaApiV3ProfilePublicCertificateGet401Response.message) &&
        Objects.equals(this.example, abhaApiV3ProfilePublicCertificateGet401Response.example);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, example);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfilePublicCertificateGet401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfilePublicCertificateGet401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfilePublicCertificateGet401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfilePublicCertificateGet401Response is not found in the empty JSON string", AbhaApiV3ProfilePublicCertificateGet401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfilePublicCertificateGet401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfilePublicCertificateGet401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfilePublicCertificateGet401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfilePublicCertificateGet401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfilePublicCertificateGet401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfilePublicCertificateGet401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfilePublicCertificateGet401Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfilePublicCertificateGet401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfilePublicCertificateGet401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfilePublicCertificateGet401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfilePublicCertificateGet401Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfilePublicCertificateGet401Response
   */
  public static AbhaApiV3ProfilePublicCertificateGet401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfilePublicCertificateGet401Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfilePublicCertificateGet401Response to an JSON string
   *
   * @return JSON string
   */
