...
/**
 * AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6
 */
...
public class AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6() {
  }

  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 scope(@javax.annotation.Nullable String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 = (AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6) o;
    return Objects.equals(this.scope, abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.scope) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 is not found in the empty JSON string", AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6
   */
  public static AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner6 to an JSON string
   *
   * @return JSON string
   */
