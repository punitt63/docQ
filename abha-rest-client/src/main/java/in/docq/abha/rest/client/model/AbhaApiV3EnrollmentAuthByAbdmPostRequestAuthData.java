...
/**
 * AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData
 */
...
public class AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp otp;

  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData() {
  }

  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData authMethods(@javax.annotation.Nonnull List<String> authMethods) {
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData otp(@javax.annotation.Nonnull AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp otp) {
    this.otp = otp;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp getOtp() {
    return otp;
  }

  public void setOtp(@javax.annotation.Nonnull AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp otp) {
    this.otp = otp;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData abhaApiV3EnrollmentAuthByAbdmPostRequestAuthData = (AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData) o;
    return Objects.equals(this.authMethods, abhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.authMethods) &&
        Objects.equals(this.otp, abhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.otp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData is not found in the empty JSON string", AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("authMethods").isJsonPrimitive()) {
      ...
      AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthDataOtp.validateJsonElement(jsonObj.get("otp"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData
   */
  public static AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentAuthByAbdmPostRequestAuthData to an JSON string
   *
   * @return JSON string
   */
