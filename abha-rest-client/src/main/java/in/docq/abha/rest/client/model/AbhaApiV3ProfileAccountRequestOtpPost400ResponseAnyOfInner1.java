...
/**
 * AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1
 */
...
public class AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 {
  public static final String SERIALIZED_NAME_INVALID_LOGIN_ID = "Invalid LoginId";
  @SerializedName(SERIALIZED_NAME_INVALID_LOGIN_ID)
  ...
  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1() {
  }

  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 invalidLoginId(@javax.annotation.Nullable String invalidLoginId) {
  ...
  public void setInvalidLoginId(@javax.annotation.Nullable String invalidLoginId) {
    this.invalidLoginId = invalidLoginId;
  }


  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 = (AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1) o;
    return Objects.equals(this.invalidLoginId, abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.invalidLoginId) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidLoginId, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 {\n");
    sb.append("    invalidLoginId: ").append(toIndentedString(invalidLoginId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("Invalid LoginId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("Invalid LoginId") != null && !jsonObj.get("Invalid LoginId").isJsonNull()) && !jsonObj.get("Invalid LoginId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Invalid LoginId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Invalid LoginId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1
   */
  public static AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner1 to an JSON string
   *
   * @return JSON string
   */
