...
/**
 * AbhaApiV3ProfileAccountGet404Response
 */
...
public class AbhaApiV3ProfileAccountGet404Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3ProfileAccountGet404ResponseError error;

  public AbhaApiV3ProfileAccountGet404Response() {
  }

  public AbhaApiV3ProfileAccountGet404Response error(@javax.annotation.Nullable AbhaApiV3ProfileAccountGet404ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3ProfileAccountGet404ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3ProfileAccountGet404ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountGet404Response abhaApiV3ProfileAccountGet404Response = (AbhaApiV3ProfileAccountGet404Response) o;
    return Objects.equals(this.error, abhaApiV3ProfileAccountGet404Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountGet404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountGet404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountGet404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountGet404Response is not found in the empty JSON string", AbhaApiV3ProfileAccountGet404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountGet404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountGet404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3ProfileAccountGet404ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountGet404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountGet404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountGet404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountGet404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountGet404Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountGet404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountGet404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountGet404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountGet404Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountGet404Response
   */
  public static AbhaApiV3ProfileAccountGet404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountGet404Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountGet404Response to an JSON string
   *
   * @return JSON string
   */
