...
/**
 * AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2
 */
...
public class AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 {
  public static final String SERIALIZED_NAME_INVALID_LOGIN_HINT = "Invalid Login Hint";
  @SerializedName(SERIALIZED_NAME_INVALID_LOGIN_HINT)
  @javax.annotation.Nullable
  private String invalidLoginHint;
  ...
  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2() {
  }

  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 invalidLoginHint(@javax.annotation.Nullable String invalidLoginHint) {
    this.invalidLoginHint = invalidLoginHint;
    return this;
  }

  /**
   * Get invalidLoginHint
   * @return invalidLoginHint
   */
  @javax.annotation.Nullable
  public String getInvalidLoginHint() {
    return invalidLoginHint;
  }

  public void setInvalidLoginHint(@javax.annotation.Nullable String invalidLoginHint) {
    this.invalidLoginHint = invalidLoginHint;
  }


  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 = (AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2) o;
    return Objects.equals(this.invalidLoginHint, abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.invalidLoginHint) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidLoginHint, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 {\n");
    sb.append("    invalidLoginHint: ").append(toIndentedString(invalidLoginHint)).append("\n");
  ...
  static {
    ...
    openapiFields.add("Invalid Login Hint");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("Invalid Login Hint") != null && !jsonObj.get("Invalid Login Hint").isJsonNull()) && !jsonObj.get("Invalid Login Hint").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Invalid Login Hint` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Invalid Login Hint").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2
   */
  public static AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner2 to an JSON string
   *
   * @return JSON string
   */
