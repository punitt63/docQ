...
/**
 * AbhaApiV3ProfileAccountGet404ResponseError
 */
...
public class AbhaApiV3ProfileAccountGet404ResponseError {
  ...
  public AbhaApiV3ProfileAccountGet404ResponseError() {
  }

  public AbhaApiV3ProfileAccountGet404ResponseError code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountGet404ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountGet404ResponseError abhaApiV3ProfileAccountGet404ResponseError = (AbhaApiV3ProfileAccountGet404ResponseError) o;
    return Objects.equals(this.code, abhaApiV3ProfileAccountGet404ResponseError.code) &&
        Objects.equals(this.message, abhaApiV3ProfileAccountGet404ResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountGet404ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountGet404ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountGet404ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountGet404ResponseError is not found in the empty JSON string", AbhaApiV3ProfileAccountGet404ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountGet404ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountGet404ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountGet404ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountGet404ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountGet404ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountGet404ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountGet404ResponseError>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountGet404ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountGet404ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountGet404ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountGet404ResponseError
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountGet404ResponseError
   */
  public static AbhaApiV3ProfileAccountGet404ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountGet404ResponseError.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountGet404ResponseError to an JSON string
   *
   * @return JSON string
   */
