...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 authMethods(@javax.annotation.Nullable String authMethods) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 = (AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1) o;
    return Objects.equals(this.authMethods, abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.authMethods) &&
        Objects.equals(this.timestamp, abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf1 to an JSON string
   *
   * @return JSON string
   */
