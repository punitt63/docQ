...
import in.docq.abha.rest.client.model.AbhaApiV3ProfileAccountRequestTokenGet200Response;
import in.docq.abha.rest.client.model.AbhaApiV3ProfilePublicCertificateGet200Response;
...
public class UtilitiesApi {
    ...
    /**
     * Build call for abhaApiV3ProfileAccountRequestTokenGet
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> The token was successfully generated and sent to the user’s registered contact method. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The 400 response code indicates a bad request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The 401 response code indicates an unauthorized request. In this context, it refers to the lack of proper authentication during the operation of the Invalid Credentials &lt;br&gt;&lt;br&gt; </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call abhaApiV3ProfileAccountRequestTokenGetCall(String rToken, String TIMESTAMP, String REQUEST_ID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/abha/api/v3/profile/account/request/token";
    ...
    private okhttp3.Call abhaApiV3ProfileAccountRequestTokenGetValidateBeforeCall(String rToken, String TIMESTAMP, String REQUEST_ID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'rToken' is set
        if (rToken == null) {
            throw new ApiException("Missing the required parameter 'rToken' when calling abhaApiV3ProfileAccountRequestTokenGet(Async)");
        }

        // verify the required parameter 'TIMESTAMP' is set
        if (TIMESTAMP == null) {
            throw new ApiException("Missing the required parameter 'TIMESTAMP' when calling abhaApiV3ProfileAccountRequestTokenGet(Async)");
        }

        // verify the required parameter 'REQUEST_ID' is set
        if (REQUEST_ID == null) {
            throw new ApiException("Missing the required parameter 'REQUEST_ID' when calling abhaApiV3ProfileAccountRequestTokenGet(Async)");
        }

        return abhaApiV3ProfileAccountRequestTokenGetCall(rToken, TIMESTAMP, REQUEST_ID, _callback);

    }

    /**
     * Use Case: Request a token for accessing a user’s ABHA
     ...
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     * @return AbhaApiV3ProfileAccountRequestTokenGet200Response
     ...
     */
    public AbhaApiV3ProfileAccountRequestTokenGet200Response abhaApiV3ProfileAccountRequestTokenGet(String rToken, String TIMESTAMP, String REQUEST_ID) throws ApiException {
        ApiResponse<AbhaApiV3ProfileAccountRequestTokenGet200Response> localVarResp = abhaApiV3ProfileAccountRequestTokenGetWithHttpInfo(rToken, TIMESTAMP, REQUEST_ID);
     ...
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     * @return ApiResponse&lt;AbhaApiV3ProfileAccountRequestTokenGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<AbhaApiV3ProfileAccountRequestTokenGet200Response> abhaApiV3ProfileAccountRequestTokenGetWithHttpInfo(String rToken, String TIMESTAMP, String REQUEST_ID) throws ApiException {
        okhttp3.Call localVarCall = abhaApiV3ProfileAccountRequestTokenGetValidateBeforeCall(rToken, TIMESTAMP, REQUEST_ID, null);
        Type localVarReturnType = new TypeToken<AbhaApiV3ProfileAccountRequestTokenGet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Use Case: Request a token for accessing a user’s ABHA (asynchronously)
     * This API endpoint is used to request a token for accessing a user’s ABHA (Ayushman Bharat Health Account) profile. This token is essential for authenticating and authorizing the user to perform various actions within their profile.
     * @param rToken  (required)
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     ...
     */
    public okhttp3.Call abhaApiV3ProfileAccountRequestTokenGetAsync(String rToken, String TIMESTAMP, String REQUEST_ID, final ApiCallback<AbhaApiV3ProfileAccountRequestTokenGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = abhaApiV3ProfileAccountRequestTokenGetValidateBeforeCall(rToken, TIMESTAMP, REQUEST_ID, _callback);
        Type localVarReturnType = new TypeToken<AbhaApiV3ProfileAccountRequestTokenGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for abhaApiV3ProfilePublicCertificateGet
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call abhaApiV3ProfilePublicCertificateGetCall(String TIMESTAMP, String REQUEST_ID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/abha/api/v3/profile/public/certificate";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call abhaApiV3ProfilePublicCertificateGetValidateBeforeCall(String TIMESTAMP, String REQUEST_ID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'TIMESTAMP' is set
        if (TIMESTAMP == null) {
            throw new ApiException("Missing the required parameter 'TIMESTAMP' when calling abhaApiV3ProfilePublicCertificateGet(Async)");
        }

        // verify the required parameter 'REQUEST_ID' is set
        if (REQUEST_ID == null) {
            throw new ApiException("Missing the required parameter 'REQUEST_ID' when calling abhaApiV3ProfilePublicCertificateGet(Async)");
        }

        return abhaApiV3ProfilePublicCertificateGetCall(TIMESTAMP, REQUEST_ID, _callback);

    }

    /**
     * Use Case: Used to Fetch Public Key
     * This API endpoint is used to fetch the public key and RSA encryptionAlgorithm supported by ABHA V3 system.
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     * @return AbhaApiV3ProfilePublicCertificateGet200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public AbhaApiV3ProfilePublicCertificateGet200Response abhaApiV3ProfilePublicCertificateGet(String TIMESTAMP, String REQUEST_ID) throws ApiException {
        ApiResponse<AbhaApiV3ProfilePublicCertificateGet200Response> localVarResp = abhaApiV3ProfilePublicCertificateGetWithHttpInfo(TIMESTAMP, REQUEST_ID);
        return localVarResp.getData();
    }
     ...
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     * @return ApiResponse&lt;AbhaApiV3ProfilePublicCertificateGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<AbhaApiV3ProfilePublicCertificateGet200Response> abhaApiV3ProfilePublicCertificateGetWithHttpInfo(String TIMESTAMP, String REQUEST_ID) throws ApiException {
        okhttp3.Call localVarCall = abhaApiV3ProfilePublicCertificateGetValidateBeforeCall(TIMESTAMP, REQUEST_ID, null);
        Type localVarReturnType = new TypeToken<AbhaApiV3ProfilePublicCertificateGet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Use Case: Used to Fetch Public Key (asynchronously)
     * This API endpoint is used to fetch the public key and RSA encryptionAlgorithm supported by ABHA V3 system.
     * @param TIMESTAMP  (required)
     * @param REQUEST_ID  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call abhaApiV3ProfilePublicCertificateGetAsync(String TIMESTAMP, String REQUEST_ID, final ApiCallback<AbhaApiV3ProfilePublicCertificateGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = abhaApiV3ProfilePublicCertificateGetValidateBeforeCall(TIMESTAMP, REQUEST_ID, _callback);
        Type localVarReturnType = new TypeToken<AbhaApiV3ProfilePublicCertificateGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
