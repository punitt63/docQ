...
/**
 * AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner
 */
...
public class AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner {
  ...
  public AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner() {
  }

  public AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner PID(@javax.annotation.Nullable String PID) {
    this.PID = PID;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner abhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner = (AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner) o;
    return Objects.equals(this.PID, abhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.PID) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner
   */
  public static AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyPost400ResponseAnyOfInner to an JSON string
   *
   * @return JSON string
   */
