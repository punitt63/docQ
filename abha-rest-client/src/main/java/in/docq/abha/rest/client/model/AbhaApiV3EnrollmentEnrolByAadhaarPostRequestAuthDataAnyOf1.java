...
public class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 {
  public static final String SERIALIZED_NAME_DEMO_AUTH = "demo_auth";
  @SerializedName(SERIALIZED_NAME_DEMO_AUTH)
  @javax.annotation.Nonnull
  private AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth demoAuth;

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 demoAuth(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth demoAuth) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth getDemoAuth() {
    return demoAuth;
  }

  public void setDemoAuth(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth demoAuth) {
    this.demoAuth = demoAuth;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 = (AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1) o;
    return Objects.equals(this.demoAuth, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.demoAuth);
  }

  @Override
  public int hashCode() {
    return Objects.hash(demoAuth);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 {\n");
    sb.append("    demoAuth: ").append(toIndentedString(demoAuth)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("demo_auth");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("demo_auth");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `demo_auth`
      AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.validateJsonElement(jsonObj.get("demo_auth"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1 to an JSON string
   *
   * @return JSON string
   */
