...
/**
 * AbhaApiV3PhrWebLoginAbhaSearchPost404Response
 */
...
public class AbhaApiV3PhrWebLoginAbhaSearchPost404Response {
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost404Response() {
  }

  public AbhaApiV3PhrWebLoginAbhaSearchPost404Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaSearchPost404Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaSearchPost404Response abhaApiV3PhrWebLoginAbhaSearchPost404Response = (AbhaApiV3PhrWebLoginAbhaSearchPost404Response) o;
    return Objects.equals(this.code, abhaApiV3PhrWebLoginAbhaSearchPost404Response.code) &&
        Objects.equals(this.message, abhaApiV3PhrWebLoginAbhaSearchPost404Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaSearchPost404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaSearchPost404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaSearchPost404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaSearchPost404Response is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaSearchPost404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaSearchPost404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaSearchPost404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaSearchPost404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaSearchPost404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaSearchPost404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaSearchPost404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaSearchPost404Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaSearchPost404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaSearchPost404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaSearchPost404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaSearchPost404Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaSearchPost404Response
   */
  public static AbhaApiV3PhrWebLoginAbhaSearchPost404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaSearchPost404Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaSearchPost404Response to an JSON string
   *
   * @return JSON string
   */
