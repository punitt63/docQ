...
/**
 * AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp
 */
...
public class AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp {
  ...
  public AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp() {
  }

  public AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp txnId(@javax.annotation.Nonnull String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp otpValue(@javax.annotation.Nonnull String otpValue) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp abhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp = (AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp) o;
    return Objects.equals(this.txnId, abhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.txnId) &&
        Objects.equals(this.otpValue, abhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.otpValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp
   */
  public static AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp to an JSON string
   *
   * @return JSON string
   */
