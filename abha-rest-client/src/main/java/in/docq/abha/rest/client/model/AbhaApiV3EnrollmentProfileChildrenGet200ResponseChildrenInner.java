...
/**
 * AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner
 */
...
public class AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner {
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner() {
  }

  public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner dateOfBirth(@javax.annotation.Nullable String dateOfBirth) {
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner gender(@javax.annotation.Nullable String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner phrAddress(@javax.annotation.Nullable String phrAddress) {
  ...
  public void setPhrAddress(@javax.annotation.Nullable String phrAddress) {
    this.phrAddress = phrAddress;
  }


  public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner abHANumber(@javax.annotation.Nullable String abHANumber) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner abhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner = (AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner) o;
    return Objects.equals(this.dateOfBirth, abhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.dateOfBirth) &&
        Objects.equals(this.name, abhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.name) &&
        Objects.equals(this.gender, abhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.gender) &&
        Objects.equals(this.phrAddress, abhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.phrAddress) &&
        Objects.equals(this.abHANumber, abhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.abHANumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dateOfBirth, name, gender, phrAddress, abHANumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner is not found in the empty JSON string", AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("phrAddress") != null && !jsonObj.get("phrAddress").isJsonNull()) && !jsonObj.get("phrAddress").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `phrAddress` to be a primitive type in the JSON string but got `%s`", jsonObj.get("phrAddress").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner
   */
  public static AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentProfileChildrenGet200ResponseChildrenInner to an JSON string
   *
   * @return JSON string
   */
