...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error abhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error = (AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error) o;
    return Objects.equals(this.code, abhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.code) &&
        Objects.equals(this.message, abhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost401ResponseAnyOf1Error to an JSON string
   *
   * @return JSON string
   */
