...
/**
 * AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf
 */
...
public class AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf() {
  }

  public AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf abhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf = (AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf) o;
    return Objects.equals(this.message, abhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.message) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf
   */
  public static AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyUserPost400ResponseAnyOf to an JSON string
   *
   * @return JSON string
   */
