...
/**
 * AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner
 */
...
public class AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner {
  public static final String SERIALIZED_NAME_INVALID_SCOPE = "Invalid Scope";
  @SerializedName(SERIALIZED_NAME_INVALID_SCOPE)
  ...
  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner() {
  }

  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner invalidScope(@javax.annotation.Nullable String invalidScope) {
   ...
   */
  @javax.annotation.Nullable
  public String getInvalidScope() {
    return invalidScope;
  }

  public void setInvalidScope(@javax.annotation.Nullable String invalidScope) {
    this.invalidScope = invalidScope;
  }


  public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner = (AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner) o;
    return Objects.equals(this.invalidScope, abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.invalidScope) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invalidScope, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner {\n");
    sb.append("    invalidScope: ").append(toIndentedString(invalidScope)).append("\n");
  ...
  static {
    ...
    openapiFields.add("Invalid Scope");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("Invalid Scope") != null && !jsonObj.get("Invalid Scope").isJsonNull()) && !jsonObj.get("Invalid Scope").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Invalid Scope` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Invalid Scope").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner
   */
  public static AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestOtpPost400ResponseAnyOfInner to an JSON string
   *
   * @return JSON string
   */
