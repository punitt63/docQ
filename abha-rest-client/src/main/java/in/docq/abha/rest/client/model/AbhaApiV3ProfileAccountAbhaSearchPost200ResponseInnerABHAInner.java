...
/**
 * AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner
 */
...
public class AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner {
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner() {
  }

  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner index(@javax.annotation.Nullable Integer index) {
    this.index = index;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner abHANumber(@javax.annotation.Nullable String abHANumber) {
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner gender(@javax.annotation.Nullable String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner abhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner = (AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner) o;
    return Objects.equals(this.index, abhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.index) &&
        Objects.equals(this.abHANumber, abhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.abHANumber) &&
        Objects.equals(this.name, abhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.name) &&
        Objects.equals(this.gender, abhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.gender);
  }

  @Override
  public int hashCode() {
    return Objects.hash(index, abHANumber, name, gender);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner is not found in the empty JSON string", AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner
   */
  public static AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountAbhaSearchPost200ResponseInnerABHAInner to an JSON string
   *
   * @return JSON string
   */
