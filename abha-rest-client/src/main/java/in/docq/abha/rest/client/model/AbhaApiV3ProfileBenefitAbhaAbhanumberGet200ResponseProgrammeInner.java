...
/**
 * AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner
 */
...
public class AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner {
  public static final String SERIALIZED_NAME_BENEFIT_NAME = "benefitName";
  @SerializedName(SERIALIZED_NAME_BENEFIT_NAME)
  @javax.annotation.Nullable
  private String benefitName;

  public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner() {
  }

  public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner benefitName(@javax.annotation.Nullable String benefitName) {
  ...
  public void setBenefitName(@javax.annotation.Nullable String benefitName) {
    this.benefitName = benefitName;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner abhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner = (AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner) o;
    return Objects.equals(this.benefitName, abhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.benefitName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(benefitName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner is not found in the empty JSON string", AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner
   */
  public static AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner to an JSON string
   *
   * @return JSON string
   */
