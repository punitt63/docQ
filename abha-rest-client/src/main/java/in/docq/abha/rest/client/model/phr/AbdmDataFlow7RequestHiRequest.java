...
public class AbdmDataFlow7RequestHiRequest {
  ...
  public AbdmDataFlow7RequestHiRequest consent(@javax.annotation.Nonnull AbdmDataFlow7RequestHiRequestConsent consent) {
  ...
  public void setConsent(@javax.annotation.Nonnull AbdmDataFlow7RequestHiRequestConsent consent) {
    this.consent = consent;
  }


  public AbdmDataFlow7RequestHiRequest dateRange(@javax.annotation.Nonnull AbdmDataFlow7RequestHiRequestDateRange dateRange) {
  ...
  public void setDateRange(@javax.annotation.Nonnull AbdmDataFlow7RequestHiRequestDateRange dateRange) {
    this.dateRange = dateRange;
  }


  public AbdmDataFlow7RequestHiRequest dataPushUrl(@javax.annotation.Nonnull String dataPushUrl) {
  ...
  public AbdmDataFlow7RequestHiRequest keyMaterial(@javax.annotation.Nonnull AbdmDataFlow7RequestHiRequestKeyMaterial keyMaterial) {
  ...
  public void setKeyMaterial(@javax.annotation.Nonnull AbdmDataFlow7RequestHiRequestKeyMaterial keyMaterial) {
    this.keyMaterial = keyMaterial;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.consent, abdmDataFlow7RequestHiRequest.consent) &&
        Objects.equals(this.dateRange, abdmDataFlow7RequestHiRequest.dateRange) &&
        Objects.equals(this.dataPushUrl, abdmDataFlow7RequestHiRequest.dataPushUrl) &&
        Objects.equals(this.keyMaterial, abdmDataFlow7RequestHiRequest.keyMaterial);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbdmDataFlow7RequestHiRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbdmDataFlow7RequestHiRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbdmDataFlow7RequestHiRequest is not found in the empty JSON string", AbdmDataFlow7RequestHiRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbdmDataFlow7RequestHiRequest.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : AbdmDataFlow7RequestHiRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbdmDataFlow7RequestHiRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbdmDataFlow7RequestHiRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbdmDataFlow7RequestHiRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbdmDataFlow7RequestHiRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbdmDataFlow7RequestHiRequest>() {
           @Override
           public void write(JsonWriter out, AbdmDataFlow7RequestHiRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbdmDataFlow7RequestHiRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbdmDataFlow7RequestHiRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbdmDataFlow7RequestHiRequest
   * @throws IOException if the JSON string is invalid with respect to AbdmDataFlow7RequestHiRequest
   */
  public static AbdmDataFlow7RequestHiRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbdmDataFlow7RequestHiRequest.class);
  }

  /**
   * Convert an instance of AbdmDataFlow7RequestHiRequest to an JSON string
   *
   * @return JSON string
   */
