...
/**
 * AbhaApiV3ProfileLoginVerifyPostRequestAuthData
 */
...
public class AbhaApiV3ProfileLoginVerifyPostRequestAuthData {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp otp;

  public AbhaApiV3ProfileLoginVerifyPostRequestAuthData() {
  }

  public AbhaApiV3ProfileLoginVerifyPostRequestAuthData authMethods(@javax.annotation.Nonnull List<String> authMethods) {
    this.authMethods = authMethods;
    return this;
  }

  public AbhaApiV3ProfileLoginVerifyPostRequestAuthData addAuthMethodsItem(String authMethodsItem) {
  ...
  public AbhaApiV3ProfileLoginVerifyPostRequestAuthData otp(@javax.annotation.Nonnull AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp otp) {
    this.otp = otp;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp getOtp() {
    return otp;
  }

  public void setOtp(@javax.annotation.Nonnull AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp otp) {
    this.otp = otp;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyPostRequestAuthData abhaApiV3ProfileLoginVerifyPostRequestAuthData = (AbhaApiV3ProfileLoginVerifyPostRequestAuthData) o;
    return Objects.equals(this.authMethods, abhaApiV3ProfileLoginVerifyPostRequestAuthData.authMethods) &&
        Objects.equals(this.otp, abhaApiV3ProfileLoginVerifyPostRequestAuthData.otp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginVerifyPostRequestAuthData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyPostRequestAuthData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyPostRequestAuthData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyPostRequestAuthData is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyPostRequestAuthData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyPostRequestAuthData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyPostRequestAuthData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileLoginVerifyPostRequestAuthData.openapiRequiredFields) {
      ...
      AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.validateJsonElement(jsonObj.get("otp"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyPostRequestAuthData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyPostRequestAuthData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyPostRequestAuthData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyPostRequestAuthData.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyPostRequestAuthData>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyPostRequestAuthData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyPostRequestAuthData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyPostRequestAuthData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyPostRequestAuthData
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyPostRequestAuthData
   */
  public static AbhaApiV3ProfileLoginVerifyPostRequestAuthData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyPostRequestAuthData.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyPostRequestAuthData to an JSON string
   *
   * @return JSON string
   */
