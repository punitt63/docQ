...
/**
 * ApiHiecmGatewayV3SessionsPostRequest
 */
...
public class ApiHiecmGatewayV3SessionsPostRequest {
  ...
  public ApiHiecmGatewayV3SessionsPostRequest clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public ApiHiecmGatewayV3SessionsPostRequest clientSecret(@javax.annotation.Nonnull String clientSecret) {
  ...
  public ApiHiecmGatewayV3SessionsPostRequest grantType(@javax.annotation.Nullable String grantType) {
  ...
  public boolean equals(Object o) {
    ...
    ApiHiecmGatewayV3SessionsPostRequest apiHiecmGatewayV3SessionsPostRequest = (ApiHiecmGatewayV3SessionsPostRequest) o;
    return Objects.equals(this.clientId, apiHiecmGatewayV3SessionsPostRequest.clientId) &&
        Objects.equals(this.clientSecret, apiHiecmGatewayV3SessionsPostRequest.clientSecret) &&
        Objects.equals(this.grantType, apiHiecmGatewayV3SessionsPostRequest.grantType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiHiecmGatewayV3SessionsPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiHiecmGatewayV3SessionsPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiHiecmGatewayV3SessionsPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiHiecmGatewayV3SessionsPostRequest is not found in the empty JSON string", ApiHiecmGatewayV3SessionsPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiHiecmGatewayV3SessionsPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiHiecmGatewayV3SessionsPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiHiecmGatewayV3SessionsPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiHiecmGatewayV3SessionsPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiHiecmGatewayV3SessionsPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiHiecmGatewayV3SessionsPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiHiecmGatewayV3SessionsPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiHiecmGatewayV3SessionsPostRequest>() {
           @Override
           public void write(JsonWriter out, ApiHiecmGatewayV3SessionsPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiHiecmGatewayV3SessionsPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiHiecmGatewayV3SessionsPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiHiecmGatewayV3SessionsPostRequest
   * @throws IOException if the JSON string is invalid with respect to ApiHiecmGatewayV3SessionsPostRequest
   */
  public static ApiHiecmGatewayV3SessionsPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiHiecmGatewayV3SessionsPostRequest.class);
  }

  /**
   * Convert an instance of ApiHiecmGatewayV3SessionsPostRequest to an JSON string
   *
   * @return JSON string
   */
