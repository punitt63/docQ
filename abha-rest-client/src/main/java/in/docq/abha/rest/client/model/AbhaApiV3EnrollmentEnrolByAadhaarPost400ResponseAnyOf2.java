...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 mobile(@javax.annotation.Nullable String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 = (AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2) o;
    return Objects.equals(this.mobile, abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.mobile) &&
        Objects.equals(this.timestamp, abhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mobile, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPost400ResponseAnyOf2 to an JSON string
   *
   * @return JSON string
   */
