...
/**
 * AbdmConsentManagement1RequestConsentCareContextsInner
 */
...
public class AbdmConsentManagement1RequestConsentCareContextsInner {
  ...
  public AbdmConsentManagement1RequestConsentCareContextsInner patientReference(@javax.annotation.Nonnull String patientReference) {
  ...
  public AbdmConsentManagement1RequestConsentCareContextsInner careContextReference(@javax.annotation.Nonnull String careContextReference) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.patientReference, abdmConsentManagement1RequestConsentCareContextsInner.patientReference) &&
        Objects.equals(this.careContextReference, abdmConsentManagement1RequestConsentCareContextsInner.careContextReference);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbdmConsentManagement1RequestConsentCareContextsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbdmConsentManagement1RequestConsentCareContextsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbdmConsentManagement1RequestConsentCareContextsInner is not found in the empty JSON string", AbdmConsentManagement1RequestConsentCareContextsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbdmConsentManagement1RequestConsentCareContextsInner.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : AbdmConsentManagement1RequestConsentCareContextsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbdmConsentManagement1RequestConsentCareContextsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbdmConsentManagement1RequestConsentCareContextsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbdmConsentManagement1RequestConsentCareContextsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbdmConsentManagement1RequestConsentCareContextsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbdmConsentManagement1RequestConsentCareContextsInner>() {
           @Override
           public void write(JsonWriter out, AbdmConsentManagement1RequestConsentCareContextsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbdmConsentManagement1RequestConsentCareContextsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbdmConsentManagement1RequestConsentCareContextsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbdmConsentManagement1RequestConsentCareContextsInner
   * @throws IOException if the JSON string is invalid with respect to AbdmConsentManagement1RequestConsentCareContextsInner
   */
  public static AbdmConsentManagement1RequestConsentCareContextsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbdmConsentManagement1RequestConsentCareContextsInner.class);
  }

  /**
   * Convert an instance of AbdmConsentManagement1RequestConsentCareContextsInner to an JSON string
   *
   * @return JSON string
   */
