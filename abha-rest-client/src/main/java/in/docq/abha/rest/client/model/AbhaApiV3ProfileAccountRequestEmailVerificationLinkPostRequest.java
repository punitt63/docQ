...
/**
 * AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest
 */
...
public class AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest() {
  }

  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest otpSystem(@javax.annotation.Nonnull String otpSystem) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest abhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest = (AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.loginId) &&
        Objects.equals(this.otpSystem, abhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.otpSystem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, loginHint, loginId, otpSystem);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest
   */
  public static AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestEmailVerificationLinkPostRequest to an JSON string
   *
   * @return JSON string
   */
