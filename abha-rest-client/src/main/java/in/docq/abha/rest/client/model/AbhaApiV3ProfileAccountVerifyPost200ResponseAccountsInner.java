...
/**
 * AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner
 */
...
public class AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner {
  ...
  public AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner() {
  }

  public AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner abHANumber(@javax.annotation.Nullable String abHANumber) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner abhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner = (AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner) o;
    return Objects.equals(this.abHANumber, abhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.abHANumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abHANumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner
   */
  public static AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner to an JSON string
   *
   * @return JSON string
   */
