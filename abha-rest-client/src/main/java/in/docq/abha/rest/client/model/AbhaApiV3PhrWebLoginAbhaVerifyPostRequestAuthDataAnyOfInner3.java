...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 {
  public static final String SERIALIZED_NAME_IRIS = "iris";
  @SerializedName(SERIALIZED_NAME_IRIS)
  @javax.annotation.Nullable
  private AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris iris;

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 iris(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris iris) {
    this.iris = iris;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris getIris() {
    return iris;
  }

  public void setIris(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris iris) {
    this.iris = iris;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 = (AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3) o;
    return Objects.equals(this.iris, abhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.iris);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `iris`
      if (jsonObj.get("iris") != null && !jsonObj.get("iris").isJsonNull()) {
        AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3Iris.validateJsonElement(jsonObj.get("iris"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPostRequestAuthDataAnyOfInner3 to an JSON string
   *
   * @return JSON string
   */
