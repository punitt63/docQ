...
/**
 * AbhaApiV3ProfileAccountRequestOtpPostRequest
 */
...
public class AbhaApiV3ProfileAccountRequestOtpPostRequest {
  ...
  public AbhaApiV3ProfileAccountRequestOtpPostRequest() {
  }

  public AbhaApiV3ProfileAccountRequestOtpPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileAccountRequestOtpPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileAccountRequestOtpPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3ProfileAccountRequestOtpPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public AbhaApiV3ProfileAccountRequestOtpPostRequest otpSystem(@javax.annotation.Nonnull String otpSystem) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountRequestOtpPostRequest abhaApiV3ProfileAccountRequestOtpPostRequest = (AbhaApiV3ProfileAccountRequestOtpPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileAccountRequestOtpPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3ProfileAccountRequestOtpPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3ProfileAccountRequestOtpPostRequest.loginId) &&
        Objects.equals(this.otpSystem, abhaApiV3ProfileAccountRequestOtpPostRequest.otpSystem);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountRequestOtpPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountRequestOtpPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountRequestOtpPostRequest is not found in the empty JSON string", AbhaApiV3ProfileAccountRequestOtpPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountRequestOtpPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountRequestOtpPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountRequestOtpPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountRequestOtpPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountRequestOtpPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountRequestOtpPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountRequestOtpPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountRequestOtpPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountRequestOtpPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountRequestOtpPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountRequestOtpPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountRequestOtpPostRequest
   */
  public static AbhaApiV3ProfileAccountRequestOtpPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountRequestOtpPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountRequestOtpPostRequest to an JSON string
   *
   * @return JSON string
   */
