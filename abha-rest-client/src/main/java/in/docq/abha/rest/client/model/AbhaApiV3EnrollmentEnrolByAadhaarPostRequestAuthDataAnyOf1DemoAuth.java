...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth aadhaarNumber(@javax.annotation.Nonnull String aadhaarNumber) {
  ...
  public void setAadhaarNumber(@javax.annotation.Nonnull String aadhaarNumber) {
    this.aadhaarNumber = aadhaarNumber;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth districtCode(@javax.annotation.Nonnull String districtCode) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth stateCode(@javax.annotation.Nonnull String stateCode) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth dateOfBirth(@javax.annotation.Nonnull String dateOfBirth) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth gender(@javax.annotation.Nonnull String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth mobile(@javax.annotation.Nullable String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth pinCode(@javax.annotation.Nullable String pinCode) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth address(@javax.annotation.Nullable String address) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth profilePhoto(@javax.annotation.Nullable String profilePhoto) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth = (AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth) o;
    return Objects.equals(this.aadhaarNumber, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.aadhaarNumber) &&
        Objects.equals(this.districtCode, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.districtCode) &&
        Objects.equals(this.stateCode, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.stateCode) &&
        Objects.equals(this.dateOfBirth, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.dateOfBirth) &&
        Objects.equals(this.gender, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.gender) &&
        Objects.equals(this.name, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.name) &&
        Objects.equals(this.mobile, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.mobile) &&
        Objects.equals(this.pinCode, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.pinCode) &&
        Objects.equals(this.address, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.address) &&
        Objects.equals(this.profilePhoto, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.profilePhoto);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aadhaarNumber, districtCode, stateCode, dateOfBirth, gender, name, mobile, pinCode, address, profilePhoto);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("aadhaarNumber");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("aadhaarNumber").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf1DemoAuth to an JSON string
   *
   * @return JSON string
   */
