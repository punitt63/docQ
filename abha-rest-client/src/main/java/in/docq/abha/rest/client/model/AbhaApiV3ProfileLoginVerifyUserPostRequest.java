...
/**
 * AbhaApiV3ProfileLoginVerifyUserPostRequest
 */
...
public class AbhaApiV3ProfileLoginVerifyUserPostRequest {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPostRequest() {
  }

  public AbhaApiV3ProfileLoginVerifyUserPostRequest abHANumber(@javax.annotation.Nonnull String abHANumber) {
  ...
  public AbhaApiV3ProfileLoginVerifyUserPostRequest txnId(@javax.annotation.Nonnull String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyUserPostRequest abhaApiV3ProfileLoginVerifyUserPostRequest = (AbhaApiV3ProfileLoginVerifyUserPostRequest) o;
    return Objects.equals(this.abHANumber, abhaApiV3ProfileLoginVerifyUserPostRequest.abHANumber) &&
        Objects.equals(this.txnId, abhaApiV3ProfileLoginVerifyUserPostRequest.txnId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abHANumber, txnId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginVerifyUserPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyUserPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyUserPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyUserPostRequest is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyUserPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyUserPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyUserPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileLoginVerifyUserPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyUserPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyUserPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyUserPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyUserPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyUserPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyUserPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyUserPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyUserPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyUserPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyUserPostRequest
   */
  public static AbhaApiV3ProfileLoginVerifyUserPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyUserPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyUserPostRequest to an JSON string
   *
   * @return JSON string
   */
