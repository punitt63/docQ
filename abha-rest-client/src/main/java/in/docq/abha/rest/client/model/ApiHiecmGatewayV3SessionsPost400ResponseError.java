...
/**
 * ApiHiecmGatewayV3SessionsPost400ResponseError
 */
...
public class ApiHiecmGatewayV3SessionsPost400ResponseError {
  ...
  public ApiHiecmGatewayV3SessionsPost400ResponseError() {
  }

  public ApiHiecmGatewayV3SessionsPost400ResponseError code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ApiHiecmGatewayV3SessionsPost400ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    ApiHiecmGatewayV3SessionsPost400ResponseError apiHiecmGatewayV3SessionsPost400ResponseError = (ApiHiecmGatewayV3SessionsPost400ResponseError) o;
    return Objects.equals(this.code, apiHiecmGatewayV3SessionsPost400ResponseError.code) &&
        Objects.equals(this.message, apiHiecmGatewayV3SessionsPost400ResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiHiecmGatewayV3SessionsPost400ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiHiecmGatewayV3SessionsPost400ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiHiecmGatewayV3SessionsPost400ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiHiecmGatewayV3SessionsPost400ResponseError is not found in the empty JSON string", ApiHiecmGatewayV3SessionsPost400ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiHiecmGatewayV3SessionsPost400ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiHiecmGatewayV3SessionsPost400ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiHiecmGatewayV3SessionsPost400ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiHiecmGatewayV3SessionsPost400ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiHiecmGatewayV3SessionsPost400ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiHiecmGatewayV3SessionsPost400ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiHiecmGatewayV3SessionsPost400ResponseError>() {
           @Override
           public void write(JsonWriter out, ApiHiecmGatewayV3SessionsPost400ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiHiecmGatewayV3SessionsPost400ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiHiecmGatewayV3SessionsPost400ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiHiecmGatewayV3SessionsPost400ResponseError
   * @throws IOException if the JSON string is invalid with respect to ApiHiecmGatewayV3SessionsPost400ResponseError
   */
  public static ApiHiecmGatewayV3SessionsPost400ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiHiecmGatewayV3SessionsPost400ResponseError.class);
  }

  /**
   * Convert an instance of ApiHiecmGatewayV3SessionsPost400ResponseError to an JSON string
   *
   * @return JSON string
   */
