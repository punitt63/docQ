...
/**
 * AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response
 */
...
public class AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response {
  ...
  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response() {
  }

  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response stateCode(@javax.annotation.Nullable Integer stateCode) {
  ...
  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response districtCode(@javax.annotation.Nullable Integer districtCode) {
  ...
  public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response = (AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response) o;
    return Objects.equals(this.abhaNumber, abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.abhaNumber) &&
        Objects.equals(this.stateCode, abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.stateCode) &&
        Objects.equals(this.districtCode, abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.districtCode) &&
        Objects.equals(this.status, abhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaNumber, stateCode, districtCode, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response is not found in the empty JSON string", AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response
   */
  public static AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitAbhaStatedistrictAbhanumberGet200Response to an JSON string
   *
   * @return JSON string
   */
