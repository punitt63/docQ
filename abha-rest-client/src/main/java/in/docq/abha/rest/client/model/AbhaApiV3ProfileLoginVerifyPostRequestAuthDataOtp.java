...
/**
 * AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp
 */
...
public class AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp {
  ...
  public AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp() {
  }

  public AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp otpValue(@javax.annotation.Nonnull String otpValue) {
  ...
  public AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp txnId(@javax.annotation.Nonnull String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp abhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp = (AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp) o;
    return Objects.equals(this.otpValue, abhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.otpValue) &&
        Objects.equals(this.txnId, abhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.txnId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp
   */
  public static AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyPostRequestAuthDataOtp to an JSON string
   *
   * @return JSON string
   */
