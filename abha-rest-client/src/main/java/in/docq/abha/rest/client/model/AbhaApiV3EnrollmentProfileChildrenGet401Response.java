...
/**
 * AbhaApiV3EnrollmentProfileChildrenGet401Response
 */
...
public class AbhaApiV3EnrollmentProfileChildrenGet401Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3EnrollmentProfileChildrenGet401ResponseError error;

  public AbhaApiV3EnrollmentProfileChildrenGet401Response() {
  }

  public AbhaApiV3EnrollmentProfileChildrenGet401Response error(@javax.annotation.Nullable AbhaApiV3EnrollmentProfileChildrenGet401ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3EnrollmentProfileChildrenGet401ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3EnrollmentProfileChildrenGet401ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentProfileChildrenGet401Response abhaApiV3EnrollmentProfileChildrenGet401Response = (AbhaApiV3EnrollmentProfileChildrenGet401Response) o;
    return Objects.equals(this.error, abhaApiV3EnrollmentProfileChildrenGet401Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentProfileChildrenGet401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentProfileChildrenGet401Response is not found in the empty JSON string", AbhaApiV3EnrollmentProfileChildrenGet401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentProfileChildrenGet401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentProfileChildrenGet401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3EnrollmentProfileChildrenGet401ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentProfileChildrenGet401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentProfileChildrenGet401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentProfileChildrenGet401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentProfileChildrenGet401Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentProfileChildrenGet401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentProfileChildrenGet401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentProfileChildrenGet401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentProfileChildrenGet401Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentProfileChildrenGet401Response
   */
  public static AbhaApiV3EnrollmentProfileChildrenGet401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentProfileChildrenGet401Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentProfileChildrenGet401Response to an JSON string
   *
   * @return JSON string
   */
