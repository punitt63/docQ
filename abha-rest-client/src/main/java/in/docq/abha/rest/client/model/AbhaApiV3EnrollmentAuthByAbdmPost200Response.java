...
/**
 * AbhaApiV3EnrollmentAuthByAbdmPost200Response
 */
...
public class AbhaApiV3EnrollmentAuthByAbdmPost200Response {
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPost200Response() {
  }

  public AbhaApiV3EnrollmentAuthByAbdmPost200Response txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPost200Response authResult(@javax.annotation.Nullable String authResult) {
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPost200Response accounts(@javax.annotation.Nullable List<Object> accounts) {
    this.accounts = accounts;
    return this;
  }

  public AbhaApiV3EnrollmentAuthByAbdmPost200Response addAccountsItem(Object accountsItem) {
  ...
  public void setAccounts(@javax.annotation.Nullable List<Object> accounts) {
    this.accounts = accounts;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentAuthByAbdmPost200Response abhaApiV3EnrollmentAuthByAbdmPost200Response = (AbhaApiV3EnrollmentAuthByAbdmPost200Response) o;
    return Objects.equals(this.txnId, abhaApiV3EnrollmentAuthByAbdmPost200Response.txnId) &&
        Objects.equals(this.authResult, abhaApiV3EnrollmentAuthByAbdmPost200Response.authResult) &&
        Objects.equals(this.message, abhaApiV3EnrollmentAuthByAbdmPost200Response.message) &&
        Objects.equals(this.accounts, abhaApiV3EnrollmentAuthByAbdmPost200Response.accounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentAuthByAbdmPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentAuthByAbdmPost200Response is not found in the empty JSON string", AbhaApiV3EnrollmentAuthByAbdmPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentAuthByAbdmPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentAuthByAbdmPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentAuthByAbdmPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentAuthByAbdmPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentAuthByAbdmPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentAuthByAbdmPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentAuthByAbdmPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentAuthByAbdmPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPost200Response
   */
  public static AbhaApiV3EnrollmentAuthByAbdmPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentAuthByAbdmPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentAuthByAbdmPost200Response to an JSON string
   *
   * @return JSON string
   */
