...
/**
 * AbhaApiV3ProfileAccountGet400Response
 */
...
public class AbhaApiV3ProfileAccountGet400Response {
  ...
  public AbhaApiV3ProfileAccountGet400Response() {
  }

  public AbhaApiV3ProfileAccountGet400Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileAccountGet400Response timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountGet400Response abhaApiV3ProfileAccountGet400Response = (AbhaApiV3ProfileAccountGet400Response) o;
    return Objects.equals(this.message, abhaApiV3ProfileAccountGet400Response.message) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountGet400Response.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountGet400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountGet400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountGet400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountGet400Response is not found in the empty JSON string", AbhaApiV3ProfileAccountGet400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountGet400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountGet400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountGet400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountGet400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountGet400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountGet400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountGet400Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountGet400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountGet400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountGet400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountGet400Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountGet400Response
   */
  public static AbhaApiV3ProfileAccountGet400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountGet400Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountGet400Response to an JSON string
   *
   * @return JSON string
   */
