...
/**
 * AbhaApiV3ProfileAccountPatch422ResponseError
 */
...
public class AbhaApiV3ProfileAccountPatch422ResponseError {
  ...
  public AbhaApiV3ProfileAccountPatch422ResponseError() {
  }

  public AbhaApiV3ProfileAccountPatch422ResponseError code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountPatch422ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountPatch422ResponseError abhaApiV3ProfileAccountPatch422ResponseError = (AbhaApiV3ProfileAccountPatch422ResponseError) o;
    return Objects.equals(this.code, abhaApiV3ProfileAccountPatch422ResponseError.code) &&
        Objects.equals(this.message, abhaApiV3ProfileAccountPatch422ResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountPatch422ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountPatch422ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountPatch422ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountPatch422ResponseError is not found in the empty JSON string", AbhaApiV3ProfileAccountPatch422ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountPatch422ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountPatch422ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountPatch422ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountPatch422ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountPatch422ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountPatch422ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountPatch422ResponseError>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountPatch422ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountPatch422ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountPatch422ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountPatch422ResponseError
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountPatch422ResponseError
   */
  public static AbhaApiV3ProfileAccountPatch422ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountPatch422ResponseError.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountPatch422ResponseError to an JSON string
   *
   * @return JSON string
   */
