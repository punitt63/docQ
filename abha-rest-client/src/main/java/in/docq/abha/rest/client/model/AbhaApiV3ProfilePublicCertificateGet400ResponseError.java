...
/**
 * AbhaApiV3ProfilePublicCertificateGet400ResponseError
 */
...
public class AbhaApiV3ProfilePublicCertificateGet400ResponseError {
  ...
  public AbhaApiV3ProfilePublicCertificateGet400ResponseError() {
  }

  public AbhaApiV3ProfilePublicCertificateGet400ResponseError code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3ProfilePublicCertificateGet400ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfilePublicCertificateGet400ResponseError abhaApiV3ProfilePublicCertificateGet400ResponseError = (AbhaApiV3ProfilePublicCertificateGet400ResponseError) o;
    return Objects.equals(this.code, abhaApiV3ProfilePublicCertificateGet400ResponseError.code) &&
        Objects.equals(this.message, abhaApiV3ProfilePublicCertificateGet400ResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfilePublicCertificateGet400ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfilePublicCertificateGet400ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfilePublicCertificateGet400ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfilePublicCertificateGet400ResponseError is not found in the empty JSON string", AbhaApiV3ProfilePublicCertificateGet400ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfilePublicCertificateGet400ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfilePublicCertificateGet400ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfilePublicCertificateGet400ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfilePublicCertificateGet400ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfilePublicCertificateGet400ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfilePublicCertificateGet400ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfilePublicCertificateGet400ResponseError>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfilePublicCertificateGet400ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfilePublicCertificateGet400ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfilePublicCertificateGet400ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfilePublicCertificateGet400ResponseError
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfilePublicCertificateGet400ResponseError
   */
  public static AbhaApiV3ProfilePublicCertificateGet400ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfilePublicCertificateGet400ResponseError.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfilePublicCertificateGet400ResponseError to an JSON string
   *
   * @return JSON string
   */
