...
/**
 * AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest
 */
...
public class AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest {
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest() {
  }

  public AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest txnId(@javax.annotation.Nonnull String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest abhaAddress(@javax.annotation.Nonnull String abhaAddress) {
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest preferred(@javax.annotation.Nonnull String preferred) {
  ...
  public void setPreferred(@javax.annotation.Nonnull String preferred) {
    this.preferred = preferred;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest abhaApiV3EnrollmentEnrolAbhaAddressPostRequest = (AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest) o;
    return Objects.equals(this.txnId, abhaApiV3EnrollmentEnrolAbhaAddressPostRequest.txnId) &&
        Objects.equals(this.abhaAddress, abhaApiV3EnrollmentEnrolAbhaAddressPostRequest.abhaAddress) &&
        Objects.equals(this.preferred, abhaApiV3EnrollmentEnrolAbhaAddressPostRequest.preferred);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest
   */
  public static AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolAbhaAddressPostRequest to an JSON string
   *
   * @return JSON string
   */
