...
/**
 * AbhaApiV3ProfileAccountVerifyPost200Response
 */
...
public class AbhaApiV3ProfileAccountVerifyPost200Response {
  ...
  @javax.annotation.Nullable
  private List<AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner> accounts = new ArrayList<>();

  public AbhaApiV3ProfileAccountVerifyPost200Response() {
  }

  public AbhaApiV3ProfileAccountVerifyPost200Response txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountVerifyPost200Response authResult(@javax.annotation.Nullable String authResult) {
  ...
  public AbhaApiV3ProfileAccountVerifyPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileAccountVerifyPost200Response accounts(@javax.annotation.Nullable List<AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner> accounts) {
    this.accounts = accounts;
    return this;
  }

  public AbhaApiV3ProfileAccountVerifyPost200Response addAccountsItem(AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner accountsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner> getAccounts() {
    return accounts;
  }

  public void setAccounts(@javax.annotation.Nullable List<AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner> accounts) {
    this.accounts = accounts;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPost200Response abhaApiV3ProfileAccountVerifyPost200Response = (AbhaApiV3ProfileAccountVerifyPost200Response) o;
    return Objects.equals(this.txnId, abhaApiV3ProfileAccountVerifyPost200Response.txnId) &&
        Objects.equals(this.authResult, abhaApiV3ProfileAccountVerifyPost200Response.authResult) &&
        Objects.equals(this.message, abhaApiV3ProfileAccountVerifyPost200Response.message) &&
        Objects.equals(this.accounts, abhaApiV3ProfileAccountVerifyPost200Response.accounts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, authResult, message, accounts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountVerifyPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPost200Response is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("accounts") != null && !jsonObj.get("accounts").isJsonNull()) {
        ...
        if (jsonArrayaccounts != null) {
          ...
          for (int i = 0; i < jsonArrayaccounts.size(); i++) {
            AbhaApiV3ProfileAccountVerifyPost200ResponseAccountsInner.validateJsonElement(jsonArrayaccounts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPost200Response
   */
  public static AbhaApiV3ProfileAccountVerifyPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPost200Response to an JSON string
   *
   * @return JSON string
   */
