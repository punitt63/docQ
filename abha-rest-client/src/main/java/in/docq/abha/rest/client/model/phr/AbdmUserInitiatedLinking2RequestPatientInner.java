...
/**
 * AbdmUserInitiatedLinking2RequestPatientInner
 */
...
public class AbdmUserInitiatedLinking2RequestPatientInner {
  ...
  public AbdmUserInitiatedLinking2RequestPatientInner referenceNumber(@javax.annotation.Nonnull String referenceNumber) {
  ...
  public AbdmUserInitiatedLinking2RequestPatientInner display(@javax.annotation.Nonnull String display) {
  ...
  public AbdmUserInitiatedLinking2RequestPatientInner careContexts(@javax.annotation.Nonnull List<AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner> careContexts) {
  ...
  public AbdmUserInitiatedLinking2RequestPatientInner hiType(@javax.annotation.Nonnull HiTypeEnum hiType) {
    this.hiType = hiType;
    return this;
  }
  ...
  public AbdmUserInitiatedLinking2RequestPatientInner count(@javax.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.referenceNumber, abdmUserInitiatedLinking2RequestPatientInner.referenceNumber) &&
        Objects.equals(this.display, abdmUserInitiatedLinking2RequestPatientInner.display) &&
        Objects.equals(this.careContexts, abdmUserInitiatedLinking2RequestPatientInner.careContexts) &&
        Objects.equals(this.hiType, abdmUserInitiatedLinking2RequestPatientInner.hiType) &&
        Objects.equals(this.count, abdmUserInitiatedLinking2RequestPatientInner.count);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbdmUserInitiatedLinking2RequestPatientInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbdmUserInitiatedLinking2RequestPatientInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbdmUserInitiatedLinking2RequestPatientInner is not found in the empty JSON string", AbdmUserInitiatedLinking2RequestPatientInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbdmUserInitiatedLinking2RequestPatientInner.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : AbdmUserInitiatedLinking2RequestPatientInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbdmUserInitiatedLinking2RequestPatientInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbdmUserInitiatedLinking2RequestPatientInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbdmUserInitiatedLinking2RequestPatientInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbdmUserInitiatedLinking2RequestPatientInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbdmUserInitiatedLinking2RequestPatientInner>() {
           @Override
           public void write(JsonWriter out, AbdmUserInitiatedLinking2RequestPatientInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbdmUserInitiatedLinking2RequestPatientInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbdmUserInitiatedLinking2RequestPatientInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbdmUserInitiatedLinking2RequestPatientInner
   * @throws IOException if the JSON string is invalid with respect to AbdmUserInitiatedLinking2RequestPatientInner
   */
  public static AbdmUserInitiatedLinking2RequestPatientInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbdmUserInitiatedLinking2RequestPatientInner.class);
  }

  /**
   * Convert an instance of AbdmUserInitiatedLinking2RequestPatientInner to an JSON string
   *
   * @return JSON string
   */
