...
import in.docq.abha.rest.client.auth.HttpBearerAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://abhasbx.abdm.gov.in";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://abhasbx.abdm.gov.in
