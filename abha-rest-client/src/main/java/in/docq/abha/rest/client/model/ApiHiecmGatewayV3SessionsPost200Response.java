...
/**
 * ApiHiecmGatewayV3SessionsPost200Response
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-02-16T14:39:27.279567+05:30[Asia/Kolkata]", comments = "Generator version: 7.11.0")
public class ApiHiecmGatewayV3SessionsPost200Response {
  ...
  public ApiHiecmGatewayV3SessionsPost200Response() {
  }

  public ApiHiecmGatewayV3SessionsPost200Response accessToken(@javax.annotation.Nullable String accessToken) {
  ...
  public ApiHiecmGatewayV3SessionsPost200Response expiresIn(@javax.annotation.Nullable String expiresIn) {
  ...
  public ApiHiecmGatewayV3SessionsPost200Response refreshExpiresIn(@javax.annotation.Nullable String refreshExpiresIn) {
  ...
  public ApiHiecmGatewayV3SessionsPost200Response refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public ApiHiecmGatewayV3SessionsPost200Response tokenType(@javax.annotation.Nullable String tokenType) {
  ...
  public boolean equals(Object o) {
    ...
    ApiHiecmGatewayV3SessionsPost200Response apiHiecmGatewayV3SessionsPost200Response = (ApiHiecmGatewayV3SessionsPost200Response) o;
    return Objects.equals(this.accessToken, apiHiecmGatewayV3SessionsPost200Response.accessToken) &&
        Objects.equals(this.expiresIn, apiHiecmGatewayV3SessionsPost200Response.expiresIn) &&
        Objects.equals(this.refreshExpiresIn, apiHiecmGatewayV3SessionsPost200Response.refreshExpiresIn) &&
        Objects.equals(this.refreshToken, apiHiecmGatewayV3SessionsPost200Response.refreshToken) &&
        Objects.equals(this.tokenType, apiHiecmGatewayV3SessionsPost200Response.tokenType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiHiecmGatewayV3SessionsPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiHiecmGatewayV3SessionsPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiHiecmGatewayV3SessionsPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiHiecmGatewayV3SessionsPost200Response is not found in the empty JSON string", ApiHiecmGatewayV3SessionsPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiHiecmGatewayV3SessionsPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiHiecmGatewayV3SessionsPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiHiecmGatewayV3SessionsPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiHiecmGatewayV3SessionsPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiHiecmGatewayV3SessionsPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiHiecmGatewayV3SessionsPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiHiecmGatewayV3SessionsPost200Response>() {
           @Override
           public void write(JsonWriter out, ApiHiecmGatewayV3SessionsPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiHiecmGatewayV3SessionsPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiHiecmGatewayV3SessionsPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiHiecmGatewayV3SessionsPost200Response
   * @throws IOException if the JSON string is invalid with respect to ApiHiecmGatewayV3SessionsPost200Response
   */
  public static ApiHiecmGatewayV3SessionsPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiHiecmGatewayV3SessionsPost200Response.class);
  }

  /**
   * Convert an instance of ApiHiecmGatewayV3SessionsPost200Response to an JSON string
   *
   * @return JSON string
   */
