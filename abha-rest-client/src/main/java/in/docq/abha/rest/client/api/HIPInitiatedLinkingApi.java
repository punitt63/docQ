...
public class HIPInitiatedLinkingApi {
    ...
    public Call generateTokenCall(String token, String REQUEST_ID, OffsetDateTime TIMESTAMP, String X_HIP_ID, String X_CM_ID, HIPInitiatedGenerateTokenRequest HIPInitiatedGenerateTokenRequest, ApiCallback _callback) throws ApiException {
    ...
    private Call generateTokenValidateBeforeCall(String token, String REQUEST_ID, OffsetDateTime TIMESTAMP, String X_HIP_ID, String X_CM_ID, HIPInitiatedGenerateTokenRequest HIPInitiatedGenerateTokenRequest, ApiCallback _callback) throws ApiException {
        if (REQUEST_ID == null) {
    ...
    public CompletionStage<Void> generateTokenAsync(String token, String requestId, OffsetDateTime timestamp, String xHipId, String xCmId, HIPInitiatedGenerateTokenRequest hipInitiatedGenerateTokenRequest) {
        try {
            FutureApiCallBack<Void> callback = FutureApiCallBack.newCallback();
            okhttp3.Call localVarCall = generateTokenCall(token, requestId, timestamp, xHipId, xCmId, hipInitiatedGenerateTokenRequest, callback);
    ...
    public Call sendSmsNotificationCall(String token, UUID REQUEST_ID, OffsetDateTime TIMESTAMP, String X_CM_ID, SendSmsNotificationRequest sendSmsNotificationRequest, ApiCallback _callback) throws ApiException {
        String basePath = null;
        String[] localBasePaths = new String[0];
        if (this.localCustomBaseUrl != null) {
            basePath = this.localCustomBaseUrl;
    ...
    private Call sendSmsNotificationValidateBeforeCall(String token, UUID REQUEST_ID, OffsetDateTime TIMESTAMP, String X_CM_ID, SendSmsNotificationRequest sendSmsNotificationRequest, ApiCallback _callback) throws ApiException {
        if (REQUEST_ID == null) {
    ...
    public CompletionStage<Void> sendSmsNotificationAsync(String token, UUID requestId, OffsetDateTime timestamp, String xCmId, SendSmsNotificationRequest sendSmsNotificationRequest) {
        try {
            FutureApiCallBack<Void> callback = FutureApiCallBack.newCallback();
            okhttp3.Call localVarCall = sendSmsNotificationCall(token, requestId, timestamp, xCmId, sendSmsNotificationRequest, callback);
            Type localVarReturnType = new TypeToken<Void>() {
            }.getType();
            localVarApiClient.executeAsync(localVarCall, localVarReturnType, callback);
            return callback.getFuture();
