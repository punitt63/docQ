...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPostRequest
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPostRequest {
  public static final String SERIALIZED_NAME_AUTH_DATA = "authData";
  @SerializedName(SERIALIZED_NAME_AUTH_DATA)
  @javax.annotation.Nonnull
  private AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthData authData;

  public static final String SERIALIZED_NAME_CONSENT = "consent";
  @SerializedName(SERIALIZED_NAME_CONSENT)
  @javax.annotation.Nonnull
  private AbhaApiV3EnrollmentEnrolByAadhaarPostRequestConsent consent;

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequest() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequest authData(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthData authData) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthData getAuthData() {
    return authData;
  }

  public void setAuthData(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthData authData) {
    this.authData = authData;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequest consent(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestConsent consent) {
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestConsent getConsent() {
    return consent;
  }

  public void setConsent(@javax.annotation.Nonnull AbhaApiV3EnrollmentEnrolByAadhaarPostRequestConsent consent) {
    this.consent = consent;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPostRequest abhaApiV3EnrollmentEnrolByAadhaarPostRequest = (AbhaApiV3EnrollmentEnrolByAadhaarPostRequest) o;
    return Objects.equals(this.authData, abhaApiV3EnrollmentEnrolByAadhaarPostRequest.authData) &&
        Objects.equals(this.consent, abhaApiV3EnrollmentEnrolByAadhaarPostRequest.consent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authData, consent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPostRequest is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.openapiRequiredFields) {
      ...
      AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthData.validateJsonElement(jsonObj.get("authData"));
      // validate the required field `consent`
      AbhaApiV3EnrollmentEnrolByAadhaarPostRequestConsent.validateJsonElement(jsonObj.get("consent"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequest
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequest to an JSON string
   *
   * @return JSON string
   */
