...
/**
 * AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response
 */
...
public class AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response {
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response() {
  }

  public AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response preferred(@javax.annotation.Nullable String preferred) {
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response abhaApiV3EnrollmentEnrolAbhaAddressPost400Response = (AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response) o;
    return Objects.equals(this.preferred, abhaApiV3EnrollmentEnrolAbhaAddressPost400Response.preferred) &&
        Objects.equals(this.timestamp, abhaApiV3EnrollmentEnrolAbhaAddressPost400Response.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(preferred, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response
   */
  public static AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolAbhaAddressPost400Response to an JSON string
   *
   * @return JSON string
   */
