...
/**
 * AbhaApiV3ProfilePublicCertificateGet200Response
 */
...
public class AbhaApiV3ProfilePublicCertificateGet200Response {
  ...
  public AbhaApiV3ProfilePublicCertificateGet200Response() {
  }

  public AbhaApiV3ProfilePublicCertificateGet200Response publicKey(@javax.annotation.Nullable String publicKey) {
  ...
  public AbhaApiV3ProfilePublicCertificateGet200Response encryptionAlgorithm(@javax.annotation.Nullable String encryptionAlgorithm) {
  ...
  public void setEncryptionAlgorithm(@javax.annotation.Nullable String encryptionAlgorithm) {
    this.encryptionAlgorithm = encryptionAlgorithm;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfilePublicCertificateGet200Response abhaApiV3ProfilePublicCertificateGet200Response = (AbhaApiV3ProfilePublicCertificateGet200Response) o;
    return Objects.equals(this.publicKey, abhaApiV3ProfilePublicCertificateGet200Response.publicKey) &&
        Objects.equals(this.encryptionAlgorithm, abhaApiV3ProfilePublicCertificateGet200Response.encryptionAlgorithm);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publicKey, encryptionAlgorithm);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfilePublicCertificateGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfilePublicCertificateGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfilePublicCertificateGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfilePublicCertificateGet200Response is not found in the empty JSON string", AbhaApiV3ProfilePublicCertificateGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfilePublicCertificateGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfilePublicCertificateGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfilePublicCertificateGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfilePublicCertificateGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfilePublicCertificateGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfilePublicCertificateGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfilePublicCertificateGet200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfilePublicCertificateGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfilePublicCertificateGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfilePublicCertificateGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfilePublicCertificateGet200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfilePublicCertificateGet200Response
   */
  public static AbhaApiV3ProfilePublicCertificateGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfilePublicCertificateGet200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfilePublicCertificateGet200Response to an JSON string
   *
   * @return JSON string
   */
