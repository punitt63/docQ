...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner abhaAddress(@javax.annotation.Nullable String abhaAddress) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner fullName(@javax.annotation.Nullable String fullName) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner profilePhoto(@javax.annotation.Nullable String profilePhoto) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner kycStatus(@javax.annotation.Nullable String kycStatus) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner = (AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner) o;
    return Objects.equals(this.abhaAddress, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.abhaAddress) &&
        Objects.equals(this.fullName, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.fullName) &&
        Objects.equals(this.profilePhoto, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.profilePhoto) &&
        Objects.equals(this.abhaNumber, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.abhaNumber) &&
        Objects.equals(this.status, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.status) &&
        Objects.equals(this.kycStatus, abhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.kycStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaAddress, fullName, profilePhoto, abhaNumber, status, kycStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner to an JSON string
   *
   * @return JSON string
   */
