...
/**
 * AbhaApiV3PhrWebLoginAbhaVerifyPost200Response
 */
...
public class AbhaApiV3PhrWebLoginAbhaVerifyPost200Response {
  ...
  @javax.annotation.Nullable
  private List<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner> users = new ArrayList<>();

  public static final String SERIALIZED_NAME_TOKENS = "tokens";
  @SerializedName(SERIALIZED_NAME_TOKENS)
  @javax.annotation.Nullable
  private AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens tokens;

  public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response() {
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response authResult(@javax.annotation.Nullable String authResult) {
  ...
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response users(@javax.annotation.Nullable List<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner> users) {
    this.users = users;
    return this;
  }

  public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response addUsersItem(AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner> getUsers() {
    return users;
  }

  public void setUsers(@javax.annotation.Nullable List<AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner> users) {
    this.users = users;
  }


  public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response tokens(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens tokens) {
    this.tokens = tokens;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens getTokens() {
    return tokens;
  }

  public void setTokens(@javax.annotation.Nullable AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens tokens) {
    this.tokens = tokens;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaVerifyPost200Response abhaApiV3PhrWebLoginAbhaVerifyPost200Response = (AbhaApiV3PhrWebLoginAbhaVerifyPost200Response) o;
    return Objects.equals(this.message, abhaApiV3PhrWebLoginAbhaVerifyPost200Response.message) &&
        Objects.equals(this.authResult, abhaApiV3PhrWebLoginAbhaVerifyPost200Response.authResult) &&
        Objects.equals(this.users, abhaApiV3PhrWebLoginAbhaVerifyPost200Response.users) &&
        Objects.equals(this.tokens, abhaApiV3PhrWebLoginAbhaVerifyPost200Response.tokens);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, authResult, users, tokens);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3PhrWebLoginAbhaVerifyPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaVerifyPost200Response is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaVerifyPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaVerifyPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        ...
        if (jsonArrayusers != null) {
          ...
          for (int i = 0; i < jsonArrayusers.size(); i++) {
            AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseUsersInner.validateJsonElement(jsonArrayusers.get(i));
          };
        }
      }
      // validate the optional field `tokens`
      if (jsonObj.get("tokens") != null && !jsonObj.get("tokens").isJsonNull()) {
        AbhaApiV3PhrWebLoginAbhaVerifyPost200ResponseTokens.validateJsonElement(jsonObj.get("tokens"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaVerifyPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaVerifyPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaVerifyPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaVerifyPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaVerifyPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaVerifyPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaVerifyPost200Response
   */
  public static AbhaApiV3PhrWebLoginAbhaVerifyPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaVerifyPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaVerifyPost200Response to an JSON string
   *
   * @return JSON string
   */
