...
/**
 * AbdmUserInitiatedLinking6RequestPatientInner
 */
...
public class AbdmUserInitiatedLinking6RequestPatientInner {
  ...
  public AbdmUserInitiatedLinking6RequestPatientInner referenceNumber(@javax.annotation.Nonnull String referenceNumber) {
  ...
  public AbdmUserInitiatedLinking6RequestPatientInner display(@javax.annotation.Nullable String display) {
  ...
  public AbdmUserInitiatedLinking6RequestPatientInner careContexts(@javax.annotation.Nonnull List<AbdmUserInitiatedLinking6RequestPatientInnerCareContextsInner> careContexts) {
  ...
  public void setCareContexts(@javax.annotation.Nonnull List<AbdmUserInitiatedLinking6RequestPatientInnerCareContextsInner> careContexts) {
    this.careContexts = careContexts;
  }


  public AbdmUserInitiatedLinking6RequestPatientInner hiType(@javax.annotation.Nonnull HiTypeEnum hiType) {
    this.hiType = hiType;
    return this;
  }
  ...
  public AbdmUserInitiatedLinking6RequestPatientInner count(@javax.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.referenceNumber, abdmUserInitiatedLinking6RequestPatientInner.referenceNumber) &&
        Objects.equals(this.display, abdmUserInitiatedLinking6RequestPatientInner.display) &&
        Objects.equals(this.careContexts, abdmUserInitiatedLinking6RequestPatientInner.careContexts) &&
        Objects.equals(this.hiType, abdmUserInitiatedLinking6RequestPatientInner.hiType) &&
        Objects.equals(this.count, abdmUserInitiatedLinking6RequestPatientInner.count);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbdmUserInitiatedLinking6RequestPatientInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbdmUserInitiatedLinking6RequestPatientInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbdmUserInitiatedLinking6RequestPatientInner is not found in the empty JSON string", AbdmUserInitiatedLinking6RequestPatientInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbdmUserInitiatedLinking6RequestPatientInner.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : AbdmUserInitiatedLinking6RequestPatientInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbdmUserInitiatedLinking6RequestPatientInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbdmUserInitiatedLinking6RequestPatientInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbdmUserInitiatedLinking6RequestPatientInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbdmUserInitiatedLinking6RequestPatientInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbdmUserInitiatedLinking6RequestPatientInner>() {
           @Override
           public void write(JsonWriter out, AbdmUserInitiatedLinking6RequestPatientInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbdmUserInitiatedLinking6RequestPatientInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbdmUserInitiatedLinking6RequestPatientInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbdmUserInitiatedLinking6RequestPatientInner
   * @throws IOException if the JSON string is invalid with respect to AbdmUserInitiatedLinking6RequestPatientInner
   */
  public static AbdmUserInitiatedLinking6RequestPatientInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbdmUserInitiatedLinking6RequestPatientInner.class);
  }

  /**
   * Convert an instance of AbdmUserInitiatedLinking6RequestPatientInner to an JSON string
   *
   * @return JSON string
   */
