...
/**
 * AbhaApiV3ProfileAccountVerifyPost422Response
 */
...
public class AbhaApiV3ProfileAccountVerifyPost422Response {
  ...
  public AbhaApiV3ProfileAccountVerifyPost422Response() {
  }

  public AbhaApiV3ProfileAccountVerifyPost422Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileAccountVerifyPost422Response timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPost422Response abhaApiV3ProfileAccountVerifyPost422Response = (AbhaApiV3ProfileAccountVerifyPost422Response) o;
    return Objects.equals(this.message, abhaApiV3ProfileAccountVerifyPost422Response.message) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountVerifyPost422Response.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountVerifyPost422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPost422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPost422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPost422Response is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPost422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPost422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPost422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPost422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPost422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPost422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPost422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPost422Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPost422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPost422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPost422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPost422Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPost422Response
   */
  public static AbhaApiV3ProfileAccountVerifyPost422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPost422Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPost422Response to an JSON string
   *
   * @return JSON string
   */
