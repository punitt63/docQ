...
/**
 * AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner
 */
...
public class AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner() {
  }

  public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner abHANumber(@javax.annotation.Nullable String abHANumber) {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner preferredAbhaAddress(@javax.annotation.Nullable String preferredAbhaAddress) {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner profilePhoto(@javax.annotation.Nullable String profilePhoto) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner abhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner = (AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner) o;
    return Objects.equals(this.abHANumber, abhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.abHANumber) &&
        Objects.equals(this.preferredAbhaAddress, abhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.preferredAbhaAddress) &&
        Objects.equals(this.name, abhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.name) &&
        Objects.equals(this.status, abhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.status) &&
        Objects.equals(this.profilePhoto, abhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.profilePhoto);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abHANumber, preferredAbhaAddress, name, status, profilePhoto);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner
   */
  public static AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner to an JSON string
   *
   * @return JSON string
   */
