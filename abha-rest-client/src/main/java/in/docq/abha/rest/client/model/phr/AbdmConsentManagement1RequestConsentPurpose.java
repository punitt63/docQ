...
/**
 * AbdmConsentManagement1RequestConsentPurpose
 */
...
public class AbdmConsentManagement1RequestConsentPurpose {
  ...
  public AbdmConsentManagement1RequestConsentPurpose text(@javax.annotation.Nonnull TextEnum text) {
    this.text = text;
    return this;
  }
  ...
  public AbdmConsentManagement1RequestConsentPurpose code(@javax.annotation.Nonnull CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public AbdmConsentManagement1RequestConsentPurpose refUri(@javax.annotation.Nonnull String refUri) {
    this.refUri = refUri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.text, abdmConsentManagement1RequestConsentPurpose.text) &&
        Objects.equals(this.code, abdmConsentManagement1RequestConsentPurpose.code) &&
        Objects.equals(this.refUri, abdmConsentManagement1RequestConsentPurpose.refUri);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbdmConsentManagement1RequestConsentPurpose
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbdmConsentManagement1RequestConsentPurpose.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbdmConsentManagement1RequestConsentPurpose is not found in the empty JSON string", AbdmConsentManagement1RequestConsentPurpose.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbdmConsentManagement1RequestConsentPurpose.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : AbdmConsentManagement1RequestConsentPurpose.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbdmConsentManagement1RequestConsentPurpose.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbdmConsentManagement1RequestConsentPurpose' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbdmConsentManagement1RequestConsentPurpose> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbdmConsentManagement1RequestConsentPurpose.class));
  ...
  /**
   * Create an instance of AbdmConsentManagement1RequestConsentPurpose given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbdmConsentManagement1RequestConsentPurpose
   * @throws IOException if the JSON string is invalid with respect to AbdmConsentManagement1RequestConsentPurpose
   */
  public static AbdmConsentManagement1RequestConsentPurpose fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbdmConsentManagement1RequestConsentPurpose.class);
  }

  /**
   * Convert an instance of AbdmConsentManagement1RequestConsentPurpose to an JSON string
   *
   * @return JSON string
   */
