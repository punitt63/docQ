...
/**
 * AbhaApiV3ProfileLoginVerifyPost200Response
 */
...
public class AbhaApiV3ProfileLoginVerifyPost200Response {
  ...
  @javax.annotation.Nullable
  private List<AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner> accounts = new ArrayList<>();

  public AbhaApiV3ProfileLoginVerifyPost200Response() {
  }

  public AbhaApiV3ProfileLoginVerifyPost200Response authResult(@javax.annotation.Nullable String authResult) {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200Response token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginVerifyPost200Response expiresIn(@javax.annotation.Nullable String expiresIn) {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200Response refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public AbhaApiV3ProfileLoginVerifyPost200Response refreshExpiresIn(@javax.annotation.Nullable String refreshExpiresIn) {
  ...
  public void setRefreshExpiresIn(@javax.annotation.Nullable String refreshExpiresIn) {
    this.refreshExpiresIn = refreshExpiresIn;
  }


  public AbhaApiV3ProfileLoginVerifyPost200Response accounts(@javax.annotation.Nullable List<AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner> accounts) {
    this.accounts = accounts;
    return this;
  }

  public AbhaApiV3ProfileLoginVerifyPost200Response addAccountsItem(AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner accountsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner> getAccounts() {
    return accounts;
  }

  public void setAccounts(@javax.annotation.Nullable List<AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner> accounts) {
    this.accounts = accounts;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginVerifyPost200Response abhaApiV3ProfileLoginVerifyPost200Response = (AbhaApiV3ProfileLoginVerifyPost200Response) o;
    return Objects.equals(this.authResult, abhaApiV3ProfileLoginVerifyPost200Response.authResult) &&
        Objects.equals(this.message, abhaApiV3ProfileLoginVerifyPost200Response.message) &&
        Objects.equals(this.token, abhaApiV3ProfileLoginVerifyPost200Response.token) &&
        Objects.equals(this.expiresIn, abhaApiV3ProfileLoginVerifyPost200Response.expiresIn) &&
        Objects.equals(this.refreshToken, abhaApiV3ProfileLoginVerifyPost200Response.refreshToken) &&
        Objects.equals(this.refreshExpiresIn, abhaApiV3ProfileLoginVerifyPost200Response.refreshExpiresIn) &&
        Objects.equals(this.accounts, abhaApiV3ProfileLoginVerifyPost200Response.accounts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authResult, message, token, expiresIn, refreshToken, refreshExpiresIn, accounts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginVerifyPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginVerifyPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginVerifyPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginVerifyPost200Response is not found in the empty JSON string", AbhaApiV3ProfileLoginVerifyPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginVerifyPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginVerifyPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("refreshExpiresIn") != null && !jsonObj.get("refreshExpiresIn").isJsonNull()) && !jsonObj.get("refreshExpiresIn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `refreshExpiresIn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("refreshExpiresIn").toString()));
      }
      if (jsonObj.get("accounts") != null && !jsonObj.get("accounts").isJsonNull()) {
        ...
        if (jsonArrayaccounts != null) {
          ...
          for (int i = 0; i < jsonArrayaccounts.size(); i++) {
            AbhaApiV3ProfileLoginVerifyPost200ResponseAccountsInner.validateJsonElement(jsonArrayaccounts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginVerifyPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginVerifyPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginVerifyPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginVerifyPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginVerifyPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginVerifyPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginVerifyPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginVerifyPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginVerifyPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginVerifyPost200Response
   */
  public static AbhaApiV3ProfileLoginVerifyPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginVerifyPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginVerifyPost200Response to an JSON string
   *
   * @return JSON string
   */
