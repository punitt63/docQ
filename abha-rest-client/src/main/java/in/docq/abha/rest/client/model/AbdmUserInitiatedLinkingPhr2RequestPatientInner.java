...
import in.docq.abha.rest.client.model.AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner;
...
public class AbdmUserInitiatedLinkingPhr2RequestPatientInner {
  ...
  @javax.annotation.Nonnull
  private List<in.docq.abha.rest.client.model.AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner> careContexts = new ArrayList<>();
  ...
  public AbdmUserInitiatedLinkingPhr2RequestPatientInner careContexts(@javax.annotation.Nonnull List<in.docq.abha.rest.client.model.AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner> careContexts) {
    this.careContexts = careContexts;
    return this;
  }

  public AbdmUserInitiatedLinkingPhr2RequestPatientInner addCareContextsItem(in.docq.abha.rest.client.model.AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner careContextsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<in.docq.abha.rest.client.model.AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner> getCareContexts() {
    return careContexts;
  }

  public void setCareContexts(@javax.annotation.Nonnull List<in.docq.abha.rest.client.model.AbdmUserInitiatedLinking2RequestPatientInnerCareContextsInner> careContexts) {
    this.careContexts = careContexts;
  }
