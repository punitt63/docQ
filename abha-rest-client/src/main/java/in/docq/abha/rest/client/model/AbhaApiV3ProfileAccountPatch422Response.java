...
/**
 * AbhaApiV3ProfileAccountPatch422Response
 */
...
public class AbhaApiV3ProfileAccountPatch422Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3ProfileAccountPatch422ResponseError error;

  public AbhaApiV3ProfileAccountPatch422Response() {
  }

  public AbhaApiV3ProfileAccountPatch422Response error(@javax.annotation.Nullable AbhaApiV3ProfileAccountPatch422ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3ProfileAccountPatch422ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3ProfileAccountPatch422ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountPatch422Response abhaApiV3ProfileAccountPatch422Response = (AbhaApiV3ProfileAccountPatch422Response) o;
    return Objects.equals(this.error, abhaApiV3ProfileAccountPatch422Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountPatch422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountPatch422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountPatch422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountPatch422Response is not found in the empty JSON string", AbhaApiV3ProfileAccountPatch422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountPatch422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountPatch422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3ProfileAccountPatch422ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountPatch422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountPatch422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountPatch422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountPatch422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountPatch422Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountPatch422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountPatch422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountPatch422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountPatch422Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountPatch422Response
   */
  public static AbhaApiV3ProfileAccountPatch422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountPatch422Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountPatch422Response to an JSON string
   *
   * @return JSON string
   */
