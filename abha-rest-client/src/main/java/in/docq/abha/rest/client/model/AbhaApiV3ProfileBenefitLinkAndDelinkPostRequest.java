...
/**
 * AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest
 */
...
public class AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest {
  ...
  public AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest() {
  }

  public AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest abhaApiV3ProfileBenefitLinkAndDelinkPostRequest = (AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileBenefitLinkAndDelinkPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3ProfileBenefitLinkAndDelinkPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3ProfileBenefitLinkAndDelinkPostRequest.loginId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, loginHint, loginId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest is not found in the empty JSON string", AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest
   */
  public static AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitLinkAndDelinkPostRequest to an JSON string
   *
   * @return JSON string
   */
