...
/**
 * AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner
 */
...
public class AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner {
  ...
  public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner() {
  }

  public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner authMethods(@javax.annotation.Nullable String authMethods) {
  ...
  public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner abhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner = (AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner) o;
    return Objects.equals(this.authMethods, abhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.authMethods) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner
   */
  public static AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPost400ResponseAnyOfInner to an JSON string
   *
   * @return JSON string
   */
