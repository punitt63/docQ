...
/**
 * AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels
 */
...
public class AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels {
  ...
  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels() {
  }

  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels abhaAddress(@javax.annotation.Nullable String abhaAddress) {
  ...
  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels gender(@javax.annotation.Nullable String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels dob(@javax.annotation.Nullable String dob) {
    this.dob = dob;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels mobile(@javax.annotation.Nullable String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels = (AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels) o;
    return Objects.equals(this.name, abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.name) &&
        Objects.equals(this.abhaNumber, abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.abhaNumber) &&
        Objects.equals(this.abhaAddress, abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.abhaAddress) &&
        Objects.equals(this.gender, abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.gender) &&
        Objects.equals(this.dob, abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.dob) &&
        Objects.equals(this.mobile, abhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, abhaNumber, abhaAddress, gender, dob, mobile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels is not found in the empty JSON string", AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels
   */
  public static AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountGet200ResponseLocalizedDetailsLocalizedLabels to an JSON string
   *
   * @return JSON string
   */
