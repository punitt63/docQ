...
/**
 * AbhaApiV3ProfileLoginRequestOtpPostRequest
 */
...
public class AbhaApiV3ProfileLoginRequestOtpPostRequest {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPostRequest() {
  }

  public AbhaApiV3ProfileLoginRequestOtpPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileLoginRequestOtpPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPostRequest otpSystem(@javax.annotation.Nonnull String otpSystem) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginRequestOtpPostRequest abhaApiV3ProfileLoginRequestOtpPostRequest = (AbhaApiV3ProfileLoginRequestOtpPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileLoginRequestOtpPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3ProfileLoginRequestOtpPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3ProfileLoginRequestOtpPostRequest.loginId) &&
        Objects.equals(this.otpSystem, abhaApiV3ProfileLoginRequestOtpPostRequest.otpSystem);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginRequestOtpPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginRequestOtpPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginRequestOtpPostRequest is not found in the empty JSON string", AbhaApiV3ProfileLoginRequestOtpPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginRequestOtpPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginRequestOtpPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileLoginRequestOtpPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginRequestOtpPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginRequestOtpPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginRequestOtpPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginRequestOtpPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginRequestOtpPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginRequestOtpPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginRequestOtpPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPostRequest
   */
  public static AbhaApiV3ProfileLoginRequestOtpPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginRequestOtpPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginRequestOtpPostRequest to an JSON string
   *
   * @return JSON string
   */
