...
public class AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner() {
  }

  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner = (AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner) o;
    return Objects.equals(this.txnId, abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.txnId) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner is not found in the empty JSON string", AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner
   */
  public static AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginRequestOtpPost400ResponseAnyOfInner to an JSON string
   *
   * @return JSON string
   */
