...
/**
 * AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf
 */
...
public class AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf {
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf() {
  }

  public AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf abhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf = (AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf) o;
    return Objects.equals(this.txnId, abhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.txnId) &&
        Objects.equals(this.description, abhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf is not found in the empty JSON string", AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf
   */
  public static AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentAuthByAbdmPost400ResponseAnyOf to an JSON string
   *
   * @return JSON string
   */
