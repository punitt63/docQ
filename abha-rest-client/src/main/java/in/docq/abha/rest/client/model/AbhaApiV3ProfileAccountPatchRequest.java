...
/**
 * AbhaApiV3ProfileAccountPatchRequest
 */
...
public class AbhaApiV3ProfileAccountPatchRequest {
  ...
  public AbhaApiV3ProfileAccountPatchRequest() {
  }

  public AbhaApiV3ProfileAccountPatchRequest abhaNumber(@javax.annotation.Nonnull String abhaNumber) {
  ...
  public void setAbhaNumber(@javax.annotation.Nonnull String abhaNumber) {
    this.abhaNumber = abhaNumber;
  }


  public AbhaApiV3ProfileAccountPatchRequest dob(@javax.annotation.Nonnull String dob) {
    this.dob = dob;
    return this;
  }
  ...
  public void setDob(@javax.annotation.Nonnull String dob) {
    this.dob = dob;
  }


  public AbhaApiV3ProfileAccountPatchRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AbhaApiV3ProfileAccountPatchRequest gender(@javax.annotation.Nonnull String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountPatchRequest abhaApiV3ProfileAccountPatchRequest = (AbhaApiV3ProfileAccountPatchRequest) o;
    return Objects.equals(this.abhaNumber, abhaApiV3ProfileAccountPatchRequest.abhaNumber) &&
        Objects.equals(this.dob, abhaApiV3ProfileAccountPatchRequest.dob) &&
        Objects.equals(this.name, abhaApiV3ProfileAccountPatchRequest.name) &&
        Objects.equals(this.gender, abhaApiV3ProfileAccountPatchRequest.gender);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaNumber, dob, name, gender);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileAccountPatchRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountPatchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountPatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountPatchRequest is not found in the empty JSON string", AbhaApiV3ProfileAccountPatchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountPatchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountPatchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountPatchRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountPatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountPatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountPatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountPatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountPatchRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountPatchRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountPatchRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountPatchRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountPatchRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountPatchRequest
   */
  public static AbhaApiV3ProfileAccountPatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountPatchRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountPatchRequest to an JSON string
   *
   * @return JSON string
   */
