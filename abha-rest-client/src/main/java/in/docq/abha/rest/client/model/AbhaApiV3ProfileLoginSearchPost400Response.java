...
/**
 * AbhaApiV3ProfileLoginSearchPost400Response
 */
...
public class AbhaApiV3ProfileLoginSearchPost400Response {
  ...
  public AbhaApiV3ProfileLoginSearchPost400Response() {
  }

  public AbhaApiV3ProfileLoginSearchPost400Response abHANumber(@javax.annotation.Nullable String abHANumber) {
  ...
  public AbhaApiV3ProfileLoginSearchPost400Response timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginSearchPost400Response abhaApiV3ProfileLoginSearchPost400Response = (AbhaApiV3ProfileLoginSearchPost400Response) o;
    return Objects.equals(this.abHANumber, abhaApiV3ProfileLoginSearchPost400Response.abHANumber) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileLoginSearchPost400Response.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginSearchPost400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginSearchPost400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginSearchPost400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginSearchPost400Response is not found in the empty JSON string", AbhaApiV3ProfileLoginSearchPost400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginSearchPost400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginSearchPost400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginSearchPost400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginSearchPost400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginSearchPost400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginSearchPost400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginSearchPost400Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginSearchPost400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginSearchPost400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginSearchPost400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginSearchPost400Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginSearchPost400Response
   */
  public static AbhaApiV3ProfileLoginSearchPost400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginSearchPost400Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginSearchPost400Response to an JSON string
   *
   * @return JSON string
   */
