...
/**
 * AbhaApiV3PhrWebLoginAbhaSearchPostRequest
 */
...
public class AbhaApiV3PhrWebLoginAbhaSearchPostRequest {
  public static final String SERIALIZED_NAME_ABHA_ADDRESS = "abhaAddress";
  @SerializedName(SERIALIZED_NAME_ABHA_ADDRESS)
  @javax.annotation.Nonnull
  private String abhaAddress;

  public AbhaApiV3PhrWebLoginAbhaSearchPostRequest() {
  }

  public AbhaApiV3PhrWebLoginAbhaSearchPostRequest abhaAddress(@javax.annotation.Nonnull String abhaAddress) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaSearchPostRequest abhaApiV3PhrWebLoginAbhaSearchPostRequest = (AbhaApiV3PhrWebLoginAbhaSearchPostRequest) o;
    return Objects.equals(this.abhaAddress, abhaApiV3PhrWebLoginAbhaSearchPostRequest.abhaAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaAddress);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3PhrWebLoginAbhaSearchPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaSearchPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaSearchPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaSearchPostRequest is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaSearchPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaSearchPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaSearchPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3PhrWebLoginAbhaSearchPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaSearchPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaSearchPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaSearchPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaSearchPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaSearchPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaSearchPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaSearchPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaSearchPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaSearchPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaSearchPostRequest
   */
  public static AbhaApiV3PhrWebLoginAbhaSearchPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaSearchPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaSearchPostRequest to an JSON string
   *
   * @return JSON string
   */
