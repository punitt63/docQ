...
/**
 * AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response
 */
...
public class AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response {
  ...
  public AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response() {
  }

  public AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response benefitName(@javax.annotation.Nullable String benefitName) {
  ...
  public AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response healthId(@javax.annotation.Nullable String healthId) {
  ...
  public AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response abhaApiV3ProfileBenefitLinkAndDelinkPost200Response = (AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response) o;
    return Objects.equals(this.benefitName, abhaApiV3ProfileBenefitLinkAndDelinkPost200Response.benefitName) &&
        Objects.equals(this.healthId, abhaApiV3ProfileBenefitLinkAndDelinkPost200Response.healthId) &&
        Objects.equals(this.status, abhaApiV3ProfileBenefitLinkAndDelinkPost200Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response is not found in the empty JSON string", AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response
   */
  public static AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitLinkAndDelinkPost200Response to an JSON string
   *
   * @return JSON string
   */
