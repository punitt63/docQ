...
/**
 * AbhaApiV3ProfileAccountPatch400ResponseError
 */
...
public class AbhaApiV3ProfileAccountPatch400ResponseError {
  ...
  public AbhaApiV3ProfileAccountPatch400ResponseError() {
  }

  public AbhaApiV3ProfileAccountPatch400ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3ProfileAccountPatch400ResponseError timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountPatch400ResponseError abhaApiV3ProfileAccountPatch400ResponseError = (AbhaApiV3ProfileAccountPatch400ResponseError) o;
    return Objects.equals(this.message, abhaApiV3ProfileAccountPatch400ResponseError.message) &&
        Objects.equals(this.timestamp, abhaApiV3ProfileAccountPatch400ResponseError.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountPatch400ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountPatch400ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountPatch400ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountPatch400ResponseError is not found in the empty JSON string", AbhaApiV3ProfileAccountPatch400ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountPatch400ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountPatch400ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountPatch400ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountPatch400ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountPatch400ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountPatch400ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountPatch400ResponseError>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountPatch400ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountPatch400ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountPatch400ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountPatch400ResponseError
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountPatch400ResponseError
   */
  public static AbhaApiV3ProfileAccountPatch400ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountPatch400ResponseError.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountPatch400ResponseError to an JSON string
   *
   * @return JSON string
   */
