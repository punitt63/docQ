...
/**
 * AbhaApiV3ProfileLoginRequestOtpPost200Response
 */
...
public class AbhaApiV3ProfileLoginRequestOtpPost200Response {
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost200Response() {
  }

  public AbhaApiV3ProfileLoginRequestOtpPost200Response txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3ProfileLoginRequestOtpPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileLoginRequestOtpPost200Response abhaApiV3ProfileLoginRequestOtpPost200Response = (AbhaApiV3ProfileLoginRequestOtpPost200Response) o;
    return Objects.equals(this.txnId, abhaApiV3ProfileLoginRequestOtpPost200Response.txnId) &&
        Objects.equals(this.message, abhaApiV3ProfileLoginRequestOtpPost200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileLoginRequestOtpPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileLoginRequestOtpPost200Response is not found in the empty JSON string", AbhaApiV3ProfileLoginRequestOtpPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileLoginRequestOtpPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileLoginRequestOtpPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileLoginRequestOtpPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileLoginRequestOtpPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileLoginRequestOtpPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileLoginRequestOtpPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileLoginRequestOtpPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileLoginRequestOtpPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileLoginRequestOtpPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileLoginRequestOtpPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileLoginRequestOtpPost200Response
   */
  public static AbhaApiV3ProfileLoginRequestOtpPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileLoginRequestOtpPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileLoginRequestOtpPost200Response to an JSON string
   *
   * @return JSON string
   */
