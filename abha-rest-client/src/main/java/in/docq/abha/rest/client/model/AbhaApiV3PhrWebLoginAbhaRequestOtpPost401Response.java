...
/**
 * AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response
 */
...
public class AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response() {
  }

  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response abhaApiV3PhrWebLoginAbhaRequestOtpPost401Response = (AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response) o;
    return Objects.equals(this.code, abhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.code) &&
        Objects.equals(this.message, abhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.message) &&
        Objects.equals(this.description, abhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response
   */
  public static AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPost401Response to an JSON string
   *
   * @return JSON string
   */
