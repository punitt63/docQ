...
/**
 * AbhaApiV3ProfileAccountPatch400Response
 */
...
public class AbhaApiV3ProfileAccountPatch400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private AbhaApiV3ProfileAccountPatch400ResponseError error;

  public AbhaApiV3ProfileAccountPatch400Response() {
  }

  public AbhaApiV3ProfileAccountPatch400Response error(@javax.annotation.Nullable AbhaApiV3ProfileAccountPatch400ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AbhaApiV3ProfileAccountPatch400ResponseError getError() {
    return error;
  }

  public void setError(@javax.annotation.Nullable AbhaApiV3ProfileAccountPatch400ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountPatch400Response abhaApiV3ProfileAccountPatch400Response = (AbhaApiV3ProfileAccountPatch400Response) o;
    return Objects.equals(this.error, abhaApiV3ProfileAccountPatch400Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountPatch400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountPatch400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountPatch400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountPatch400Response is not found in the empty JSON string", AbhaApiV3ProfileAccountPatch400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountPatch400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountPatch400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `error`
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        AbhaApiV3ProfileAccountPatch400ResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountPatch400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountPatch400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountPatch400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountPatch400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountPatch400Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountPatch400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountPatch400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountPatch400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountPatch400Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountPatch400Response
   */
  public static AbhaApiV3ProfileAccountPatch400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountPatch400Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountPatch400Response to an JSON string
   *
   * @return JSON string
   */
