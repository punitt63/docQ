...
/**
 * AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face
 */
...
public class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face {
  public static final String SERIALIZED_NAME_AADHAAR = "aadhaar";
  @SerializedName(SERIALIZED_NAME_AADHAAR)
  @javax.annotation.Nonnull
  private String aadhaar;

  public static final String SERIALIZED_NAME_RD_PID_DATA = "rdPidData";
  @SerializedName(SERIALIZED_NAME_RD_PID_DATA)
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face() {
  }

  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face aadhaar(@javax.annotation.Nonnull String aadhaar) {
  ...
  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face rdPidData(@javax.annotation.Nullable String rdPidData) {
    this.rdPidData = rdPidData;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getRdPidData() {
    return rdPidData;
  }

  public void setRdPidData(@javax.annotation.Nullable String rdPidData) {
    this.rdPidData = rdPidData;
  }


  public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face mobile(@javax.annotation.Nonnull String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face = (AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face) o;
    return Objects.equals(this.aadhaar, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.aadhaar) &&
        Objects.equals(this.rdPidData, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.rdPidData) &&
        Objects.equals(this.mobile, abhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aadhaar, rdPidData, mobile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face {\n");
    sb.append("    aadhaar: ").append(toIndentedString(aadhaar)).append("\n");
    sb.append("    rdPidData: ").append(toIndentedString(rdPidData)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.openapiRequiredFields) {
      ...
      if ((jsonObj.get("rdPidData") != null && !jsonObj.get("rdPidData").isJsonNull()) && !jsonObj.get("rdPidData").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rdPidData` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rdPidData").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face
   */
  public static AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolByAadhaarPostRequestAuthDataAnyOf3Face to an JSON string
   *
   * @return JSON string
   */
