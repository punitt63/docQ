...
/**
 * AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response
 */
...
public class AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response {
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response() {
  }

  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response abhaApiV3PhrWebLoginAbhaRequestOtpPost200Response = (AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response) o;
    return Objects.equals(this.txnId, abhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.txnId) &&
        Objects.equals(this.message, abhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response is not found in the empty JSON string", AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response
   */
  public static AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3PhrWebLoginAbhaRequestOtpPost200Response to an JSON string
   *
   * @return JSON string
   */
