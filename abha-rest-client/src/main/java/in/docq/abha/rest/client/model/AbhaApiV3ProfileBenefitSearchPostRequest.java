...
/**
 * AbhaApiV3ProfileBenefitSearchPostRequest
 */
...
public class AbhaApiV3ProfileBenefitSearchPostRequest {
  ...
  public AbhaApiV3ProfileBenefitSearchPostRequest() {
  }

  public AbhaApiV3ProfileBenefitSearchPostRequest scope(@javax.annotation.Nonnull List<String> scope) {
    this.scope = scope;
    return this;
  }

  public AbhaApiV3ProfileBenefitSearchPostRequest addScopeItem(String scopeItem) {
    if (this.scope == null) {
  ...
  public AbhaApiV3ProfileBenefitSearchPostRequest loginHint(@javax.annotation.Nonnull String loginHint) {
  ...
  public AbhaApiV3ProfileBenefitSearchPostRequest loginId(@javax.annotation.Nonnull String loginId) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitSearchPostRequest abhaApiV3ProfileBenefitSearchPostRequest = (AbhaApiV3ProfileBenefitSearchPostRequest) o;
    return Objects.equals(this.scope, abhaApiV3ProfileBenefitSearchPostRequest.scope) &&
        Objects.equals(this.loginHint, abhaApiV3ProfileBenefitSearchPostRequest.loginHint) &&
        Objects.equals(this.loginId, abhaApiV3ProfileBenefitSearchPostRequest.loginId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileBenefitSearchPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitSearchPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitSearchPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitSearchPostRequest is not found in the empty JSON string", AbhaApiV3ProfileBenefitSearchPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitSearchPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitSearchPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileBenefitSearchPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitSearchPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitSearchPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitSearchPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitSearchPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitSearchPostRequest>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitSearchPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitSearchPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitSearchPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitSearchPostRequest
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitSearchPostRequest
   */
  public static AbhaApiV3ProfileBenefitSearchPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitSearchPostRequest.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitSearchPostRequest to an JSON string
   *
   * @return JSON string
   */
