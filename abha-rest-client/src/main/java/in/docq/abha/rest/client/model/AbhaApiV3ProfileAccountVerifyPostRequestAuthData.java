...
/**
 * AbhaApiV3ProfileAccountVerifyPostRequestAuthData
 */
...
public class AbhaApiV3ProfileAccountVerifyPostRequestAuthData {
  ...
  @javax.annotation.Nonnull
  private AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp otp;

  public AbhaApiV3ProfileAccountVerifyPostRequestAuthData() {
  }

  public AbhaApiV3ProfileAccountVerifyPostRequestAuthData authMethods(@javax.annotation.Nonnull List<String> authMethods) {
    this.authMethods = authMethods;
    return this;
  }

  public AbhaApiV3ProfileAccountVerifyPostRequestAuthData addAuthMethodsItem(String authMethodsItem) {
  ...
  public AbhaApiV3ProfileAccountVerifyPostRequestAuthData otp(@javax.annotation.Nonnull AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp otp) {
    this.otp = otp;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp getOtp() {
    return otp;
  }

  public void setOtp(@javax.annotation.Nonnull AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp otp) {
    this.otp = otp;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileAccountVerifyPostRequestAuthData abhaApiV3ProfileAccountVerifyPostRequestAuthData = (AbhaApiV3ProfileAccountVerifyPostRequestAuthData) o;
    return Objects.equals(this.authMethods, abhaApiV3ProfileAccountVerifyPostRequestAuthData.authMethods) &&
        Objects.equals(this.otp, abhaApiV3ProfileAccountVerifyPostRequestAuthData.otp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3ProfileAccountVerifyPostRequestAuthData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileAccountVerifyPostRequestAuthData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileAccountVerifyPostRequestAuthData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileAccountVerifyPostRequestAuthData is not found in the empty JSON string", AbhaApiV3ProfileAccountVerifyPostRequestAuthData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileAccountVerifyPostRequestAuthData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileAccountVerifyPostRequestAuthData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AbhaApiV3ProfileAccountVerifyPostRequestAuthData.openapiRequiredFields) {
      ...
      AbhaApiV3ProfileAccountVerifyPostRequestAuthDataOtp.validateJsonElement(jsonObj.get("otp"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileAccountVerifyPostRequestAuthData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileAccountVerifyPostRequestAuthData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileAccountVerifyPostRequestAuthData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileAccountVerifyPostRequestAuthData.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileAccountVerifyPostRequestAuthData>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileAccountVerifyPostRequestAuthData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileAccountVerifyPostRequestAuthData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileAccountVerifyPostRequestAuthData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileAccountVerifyPostRequestAuthData
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileAccountVerifyPostRequestAuthData
   */
  public static AbhaApiV3ProfileAccountVerifyPostRequestAuthData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileAccountVerifyPostRequestAuthData.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileAccountVerifyPostRequestAuthData to an JSON string
   *
   * @return JSON string
   */
