...
/**
 * AbhaApiV3AccountRequestLogoutGet200Response
 */
...
public class AbhaApiV3AccountRequestLogoutGet200Response {
  ...
  public AbhaApiV3AccountRequestLogoutGet200Response() {
  }

  public AbhaApiV3AccountRequestLogoutGet200Response message(@javax.annotation.Nullable String message) {
  ...
  public AbhaApiV3AccountRequestLogoutGet200Response timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3AccountRequestLogoutGet200Response abhaApiV3AccountRequestLogoutGet200Response = (AbhaApiV3AccountRequestLogoutGet200Response) o;
    return Objects.equals(this.message, abhaApiV3AccountRequestLogoutGet200Response.message) &&
        Objects.equals(this.timestamp, abhaApiV3AccountRequestLogoutGet200Response.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbhaApiV3AccountRequestLogoutGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3AccountRequestLogoutGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3AccountRequestLogoutGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3AccountRequestLogoutGet200Response is not found in the empty JSON string", AbhaApiV3AccountRequestLogoutGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3AccountRequestLogoutGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3AccountRequestLogoutGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3AccountRequestLogoutGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3AccountRequestLogoutGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3AccountRequestLogoutGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3AccountRequestLogoutGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3AccountRequestLogoutGet200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3AccountRequestLogoutGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3AccountRequestLogoutGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3AccountRequestLogoutGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3AccountRequestLogoutGet200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3AccountRequestLogoutGet200Response
   */
  public static AbhaApiV3AccountRequestLogoutGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3AccountRequestLogoutGet200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3AccountRequestLogoutGet200Response to an JSON string
   *
   * @return JSON string
   */
