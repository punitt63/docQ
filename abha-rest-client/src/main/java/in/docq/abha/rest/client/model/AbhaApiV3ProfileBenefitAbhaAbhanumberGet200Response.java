...
/**
 * AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response
 */
...
public class AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response {
  ...
  @javax.annotation.Nullable
  private List<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner> programme = new ArrayList<>();

  public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response() {
  }

  public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response abhaNumber(@javax.annotation.Nullable String abhaNumber) {
  ...
  public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response programme(@javax.annotation.Nullable List<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner> programme) {
    this.programme = programme;
    return this;
  }

  public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response addProgrammeItem(AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner programmeItem) {
    if (this.programme == null) {
      this.programme = new ArrayList<>();
    }
    this.programme.add(programmeItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner> getProgramme() {
    return programme;
  }

  public void setProgramme(@javax.annotation.Nullable List<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner> programme) {
    this.programme = programme;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response abhaApiV3ProfileBenefitAbhaAbhanumberGet200Response = (AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response) o;
    return Objects.equals(this.abhaNumber, abhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.abhaNumber) &&
        Objects.equals(this.programme, abhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.programme);
  }

  @Override
  public int hashCode() {
    return Objects.hash(abhaNumber, programme);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response is not found in the empty JSON string", AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("programme") != null && !jsonObj.get("programme").isJsonNull()) {
        JsonArray jsonArrayprogramme = jsonObj.getAsJsonArray("programme");
        if (jsonArrayprogramme != null) {
          // ensure the json data is an array
          if (!jsonObj.get("programme").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `programme` to be an array in the JSON string but got `%s`", jsonObj.get("programme").toString()));
          }

          // validate the optional field `programme` (array)
          for (int i = 0; i < jsonArrayprogramme.size(); i++) {
            AbhaApiV3ProfileBenefitAbhaAbhanumberGet200ResponseProgrammeInner.validateJsonElement(jsonArrayprogramme.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response
   */
  public static AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3ProfileBenefitAbhaAbhanumberGet200Response to an JSON string
   *
   * @return JSON string
   */
