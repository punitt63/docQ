...
/**
 * AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response
 */
...
public class AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response {
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response() {
  }

  public AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response txnId(@javax.annotation.Nullable String txnId) {
    this.txnId = txnId;
    return this;
  }
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response abhaAddress(@javax.annotation.Nullable String abhaAddress) {
  ...
  public AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response preferred(@javax.annotation.Nullable String preferred) {
  ...
  public void setPreferred(@javax.annotation.Nullable String preferred) {
    this.preferred = preferred;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response abhaApiV3EnrollmentEnrolAbhaAddressPost200Response = (AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response) o;
    return Objects.equals(this.txnId, abhaApiV3EnrollmentEnrolAbhaAddressPost200Response.txnId) &&
        Objects.equals(this.abhaAddress, abhaApiV3EnrollmentEnrolAbhaAddressPost200Response.abhaAddress) &&
        Objects.equals(this.preferred, abhaApiV3EnrollmentEnrolAbhaAddressPost200Response.preferred);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txnId, abhaAddress, preferred);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response is not found in the empty JSON string", AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("preferred") != null && !jsonObj.get("preferred").isJsonNull()) && !jsonObj.get("preferred").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response>() {
           @Override
           public void write(JsonWriter out, AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response
   * @throws IOException if the JSON string is invalid with respect to AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response
   */
  public static AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response.class);
  }

  /**
   * Convert an instance of AbhaApiV3EnrollmentEnrolAbhaAddressPost200Response to an JSON string
   *
   * @return JSON string
   */
